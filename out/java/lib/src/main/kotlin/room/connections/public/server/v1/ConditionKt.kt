...
public inline fun condition(block: room.connections.public.server.v1.ConditionKt.Dsl.() -> kotlin.Unit): room.connections.public.server.v1.Entities.Condition =
  room.connections.public.server.v1.ConditionKt.Dsl._create(room.connections.public.server.v1.Entities.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `room.connections.public.server.v1.Condition`
 */
public object ConditionKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: room.connections.public.server.v1.Entities.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: room.connections.public.server.v1.Entities.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): room.connections.public.server.v1.Entities.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun room.connections.public.server.v1.Entities.Condition.copy(block: `room.connections.public.server.v1`.ConditionKt.Dsl.() -> kotlin.Unit): room.connections.public.server.v1.Entities.Condition =
  `room.connections.public.server.v1`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
