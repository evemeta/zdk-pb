...
import room.connections.`public`.server.v1.ServiceGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for
 * room.connections.public.server.v1.Service.
 */
public object ServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) room.connections.public.server.v1.Service service as suspending
   * coroutines.
   */
  ...
  /**
   * Skeletal implementation of the room.connections.public.server.v1.Service service based on
   * Kotlin coroutines.
   */
  public abstract class ServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for room.connections.public.server.v1.Service.Count.
     *
    ...
    public open suspend fun count(request: Procedures.CountRequest): Procedures.CountResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.connections.public.server.v1.Service.Count is unimplemented"))

    /**
     * Returns the response to an RPC for room.connections.public.server.v1.Service.Range.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    public open suspend fun range(request: Procedures.RangeRequest): Procedures.RangeResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.connections.public.server.v1.Service.Range is unimplemented"))

    /**
     * Returns the response to an RPC for room.connections.public.server.v1.Service.Select.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    public open suspend fun select(request: Procedures.SelectRequest): Procedures.SelectResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.connections.public.server.v1.Service.Select is unimplemented"))
