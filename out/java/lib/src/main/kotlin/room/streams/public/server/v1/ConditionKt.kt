...
public inline fun condition(block: room.streams.public.server.v1.ConditionKt.Dsl.() -> kotlin.Unit): room.streams.public.server.v1.Entities.Condition =
  room.streams.public.server.v1.ConditionKt.Dsl._create(room.streams.public.server.v1.Entities.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object ConditionKt {
  ...
  public class Dsl private constructor(
    private val _builder: room.streams.public.server.v1.Entities.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: room.streams.public.server.v1.Entities.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): room.streams.public.server.v1.Entities.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun room.streams.public.server.v1.Entities.Condition.copy(block: `room.streams.public.server.v1`.ConditionKt.Dsl.() -> kotlin.Unit): room.streams.public.server.v1.Entities.Condition =
  `room.streams.public.server.v1`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
