...
import room.rooms.`public`.server.v1.ServiceGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for room.rooms.public.server.v1.Service.
 */
public object ServiceGrpcKt {
  ...
  public val contextMethod: MethodDescriptor<Procedures.ContextRequest, Procedures.ContextResponse>
    @JvmStatic
    get() = ServiceGrpc.getContextMethod()

  /**
   * A stub for issuing RPCs to a(n) room.rooms.public.server.v1.Service service as suspending
   * coroutines.
   */
  ...
  public class ServiceCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    public suspend fun context(request: Procedures.ContextRequest, headers: Metadata = Metadata()):
        Procedures.ContextResponse = unaryRpc(
      channel,
  ...
  /**
   * Skeletal implementation of the room.rooms.public.server.v1.Service service based on Kotlin
   * coroutines.
   */
  public abstract class ServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for room.rooms.public.server.v1.Service.Count.
     *
    ...
    public open suspend fun count(request: Procedures.CountRequest): Procedures.CountResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.rooms.public.server.v1.Service.Count is unimplemented"))

    /**
     * Returns the response to an RPC for room.rooms.public.server.v1.Service.Range.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    public open suspend fun range(request: Procedures.RangeRequest): Procedures.RangeResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.rooms.public.server.v1.Service.Range is unimplemented"))

    /**
     * Returns the response to an RPC for room.rooms.public.server.v1.Service.Select.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    public open suspend fun select(request: Procedures.SelectRequest): Procedures.SelectResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.rooms.public.server.v1.Service.Select is unimplemented"))

    /**
     * Returns the response to an RPC for room.rooms.public.server.v1.Service.Context.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    public open suspend fun context(request: Procedures.ContextRequest): Procedures.ContextResponse
        = throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.rooms.public.server.v1.Service.Context is unimplemented"))
