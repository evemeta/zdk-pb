...
public interface ChunkOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chat.chats.public.server.v1.Chunk)
   ...
   * <code>repeated .chat.chats.public.server.v1.Chat entities = 4;</code>
   */
  com.evemeta.zdk.pb.chat.server.chats.Chat getEntities(int index);
  /**
   * <pre>
   * Represents the actual chats included in this chunk.
   * </pre>
   ...
   * <code>repeated .chat.chats.public.server.v1.Chat entities = 4;</code>
   */
  com.evemeta.zdk.pb.chat.server.chats.ChatOrBuilder getEntitiesOrBuilder(
      int index);
}
