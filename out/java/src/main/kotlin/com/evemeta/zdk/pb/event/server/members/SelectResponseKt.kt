...
public inline fun selectResponse(block: com.evemeta.zdk.pb.event.server.members.SelectResponseKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.members.SelectResponse =
  com.evemeta.zdk.pb.event.server.members.SelectResponseKt.Dsl._create(com.evemeta.zdk.pb.event.server.members.SelectResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 * SelectResponse represents a message that provides the result of the select procedure.
 * ```
 *
 * Protobuf type `event.members.public.server.v1.SelectResponse`
 */
public object SelectResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.event.server.members.SelectResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.event.server.members.SelectResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.event.server.members.SelectResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.event.server.members.SelectResponse.copy(block: `com.evemeta.zdk.pb.event.server.members`.SelectResponseKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.members.SelectResponse =
  `com.evemeta.zdk.pb.event.server.members`.SelectResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
