...
public inline fun query(block: com.evemeta.zdk.pb.event.server.restrictions.QueryKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.restrictions.Query =
  com.evemeta.zdk.pb.event.server.restrictions.QueryKt.Dsl._create(com.evemeta.zdk.pb.event.server.restrictions.Query.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `event.restrictions.public.server.v1.Query`
 */
public object QueryKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.event.server.restrictions.Query.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.event.server.restrictions.Query.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.event.server.restrictions.Query = _builder.build()
    ...
    public val QueryKt.Dsl.conditionOrNull: com.evemeta.zdk.pb.event.server.restrictions.Condition?
      get() = _builder.conditionOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.event.server.restrictions.Query.copy(block: `com.evemeta.zdk.pb.event.server.restrictions`.QueryKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.restrictions.Query =
  `com.evemeta.zdk.pb.event.server.restrictions`.QueryKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.evemeta.zdk.pb.event.server.restrictions.QueryOrBuilder.conditionOrNull: com.evemeta.zdk.pb.event.server.restrictions.Condition?
