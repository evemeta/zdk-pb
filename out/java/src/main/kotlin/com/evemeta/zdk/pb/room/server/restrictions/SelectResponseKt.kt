...
public inline fun selectResponse(block: com.evemeta.zdk.pb.room.server.restrictions.SelectResponseKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.restrictions.SelectResponse =
  com.evemeta.zdk.pb.room.server.restrictions.SelectResponseKt.Dsl._create(com.evemeta.zdk.pb.room.server.restrictions.SelectResponse.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object SelectResponseKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.restrictions.SelectResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.room.server.restrictions.SelectResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.room.server.restrictions.SelectResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.restrictions.SelectResponse.copy(block: `com.evemeta.zdk.pb.room.server.restrictions`.SelectResponseKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.restrictions.SelectResponse =
  `com.evemeta.zdk.pb.room.server.restrictions`.SelectResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
