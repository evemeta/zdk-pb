...
public inline fun member(block: com.evemeta.zdk.pb.event.server.members.MemberKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.members.Member =
  com.evemeta.zdk.pb.event.server.members.MemberKt.Dsl._create(com.evemeta.zdk.pb.event.server.members.Member.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `event.members.public.server.v1.Member`
 */
public object MemberKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.event.server.members.Member.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.event.server.members.Member.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.event.server.members.Member = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.event.server.members.Member.copy(block: `com.evemeta.zdk.pb.event.server.members`.MemberKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.members.Member =
  `com.evemeta.zdk.pb.event.server.members`.MemberKt.Dsl._create(this.toBuilder()).apply { block() }._build()
