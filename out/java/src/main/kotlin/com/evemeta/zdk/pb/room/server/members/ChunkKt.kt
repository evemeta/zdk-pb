...
public inline fun chunk(block: com.evemeta.zdk.pb.room.server.members.ChunkKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.members.Chunk =
  com.evemeta.zdk.pb.room.server.members.ChunkKt.Dsl._create(com.evemeta.zdk.pb.room.server.members.Chunk.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object ChunkKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.members.Chunk.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.room.server.members.Chunk.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.room.server.members.Chunk = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.members.Chunk.copy(block: `com.evemeta.zdk.pb.room.server.members`.ChunkKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.members.Chunk =
  `com.evemeta.zdk.pb.room.server.members`.ChunkKt.Dsl._create(this.toBuilder()).apply { block() }._build()
