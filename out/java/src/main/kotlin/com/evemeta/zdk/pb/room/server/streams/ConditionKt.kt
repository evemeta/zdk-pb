...
public inline fun condition(block: com.evemeta.zdk.pb.room.server.streams.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.streams.Condition =
  com.evemeta.zdk.pb.room.server.streams.ConditionKt.Dsl._create(com.evemeta.zdk.pb.room.server.streams.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `room.streams.public.server.v1.Condition`
 */
public object ConditionKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.streams.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.room.server.streams.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.room.server.streams.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.streams.Condition.copy(block: `com.evemeta.zdk.pb.room.server.streams`.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.streams.Condition =
  `com.evemeta.zdk.pb.room.server.streams`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
