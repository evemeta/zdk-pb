...
public inline fun condition(block: com.evemeta.zdk.pb.event.server.events.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.events.Condition =
  com.evemeta.zdk.pb.event.server.events.ConditionKt.Dsl._create(com.evemeta.zdk.pb.event.server.events.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `event.events.public.server.v1.Condition`
 */
public object ConditionKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.event.server.events.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.event.server.events.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.event.server.events.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.event.server.events.Condition.copy(block: `com.evemeta.zdk.pb.event.server.events`.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.events.Condition =
  `com.evemeta.zdk.pb.event.server.events`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
