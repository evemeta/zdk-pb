...
import com.evemeta.zdk.pb.room.server.tokens.ServiceGrpc.getServiceDescriptor
 ...
 * room.tokens.public.server.v1.Service.
 */
public object ServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) room.tokens.public.server.v1.Service service as suspending
   * coroutines.
   */
  ...
  /**
   * Skeletal implementation of the room.tokens.public.server.v1.Service service based on Kotlin
   * coroutines.
   */
  public abstract class ServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for room.tokens.public.server.v1.Service.Extract.
     *
    ...
    public open suspend fun extract(request: ExtractRequest): ExtractResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method room.tokens.public.server.v1.Service.Extract is unimplemented"))
