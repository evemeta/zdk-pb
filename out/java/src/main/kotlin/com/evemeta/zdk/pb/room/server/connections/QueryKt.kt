...
public inline fun query(block: com.evemeta.zdk.pb.room.server.connections.QueryKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.connections.Query =
  com.evemeta.zdk.pb.room.server.connections.QueryKt.Dsl._create(com.evemeta.zdk.pb.room.server.connections.Query.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object QueryKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.connections.Query.Builder
  ) {
     ...
     */
    public var order: com.evemeta.zdk.pb.room.server.connections.Order
      @JvmName("getOrder")
     ...
     */
    public var condition: com.evemeta.zdk.pb.room.server.connections.Condition
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.connections.Query.copy(block: `com.evemeta.zdk.pb.room.server.connections`.QueryKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.connections.Query =
  `com.evemeta.zdk.pb.room.server.connections`.QueryKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.evemeta.zdk.pb.room.server.connections.QueryOrBuilder.conditionOrNull: com.evemeta.zdk.pb.room.server.connections.Condition?
