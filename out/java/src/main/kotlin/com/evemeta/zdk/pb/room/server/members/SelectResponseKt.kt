...
public inline fun selectResponse(block: com.evemeta.zdk.pb.room.server.members.SelectResponseKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.members.SelectResponse =
  com.evemeta.zdk.pb.room.server.members.SelectResponseKt.Dsl._create(com.evemeta.zdk.pb.room.server.members.SelectResponse.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object SelectResponseKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.members.SelectResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.room.server.members.SelectResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.room.server.members.SelectResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.members.SelectResponse.copy(block: `com.evemeta.zdk.pb.room.server.members`.SelectResponseKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.members.SelectResponse =
  `com.evemeta.zdk.pb.room.server.members`.SelectResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
