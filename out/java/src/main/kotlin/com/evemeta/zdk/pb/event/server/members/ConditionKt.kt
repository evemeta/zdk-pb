...
public inline fun condition(block: com.evemeta.zdk.pb.event.server.members.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.members.Condition =
  com.evemeta.zdk.pb.event.server.members.ConditionKt.Dsl._create(com.evemeta.zdk.pb.event.server.members.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `event.members.public.server.v1.Condition`
 */
public object ConditionKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.event.server.members.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.event.server.members.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.event.server.members.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.event.server.members.Condition.copy(block: `com.evemeta.zdk.pb.event.server.members`.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.event.server.members.Condition =
  `com.evemeta.zdk.pb.event.server.members`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
