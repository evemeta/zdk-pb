...
public inline fun condition(block: com.evemeta.zdk.pb.room.server.connections.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.connections.Condition =
  com.evemeta.zdk.pb.room.server.connections.ConditionKt.Dsl._create(com.evemeta.zdk.pb.room.server.connections.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object ConditionKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.connections.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.room.server.connections.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.room.server.connections.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.connections.Condition.copy(block: `com.evemeta.zdk.pb.room.server.connections`.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.connections.Condition =
  `com.evemeta.zdk.pb.room.server.connections`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
