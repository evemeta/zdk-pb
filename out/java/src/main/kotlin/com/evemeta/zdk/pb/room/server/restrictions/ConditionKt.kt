...
public inline fun condition(block: com.evemeta.zdk.pb.room.server.restrictions.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.restrictions.Condition =
  com.evemeta.zdk.pb.room.server.restrictions.ConditionKt.Dsl._create(com.evemeta.zdk.pb.room.server.restrictions.Condition.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object ConditionKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.evemeta.zdk.pb.room.server.restrictions.Condition.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.evemeta.zdk.pb.room.server.restrictions.Condition.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.evemeta.zdk.pb.room.server.restrictions.Condition = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.evemeta.zdk.pb.room.server.restrictions.Condition.copy(block: `com.evemeta.zdk.pb.room.server.restrictions`.ConditionKt.Dsl.() -> kotlin.Unit): com.evemeta.zdk.pb.room.server.restrictions.Condition =
  `com.evemeta.zdk.pb.room.server.restrictions`.ConditionKt.Dsl._create(this.toBuilder()).apply { block() }._build()
