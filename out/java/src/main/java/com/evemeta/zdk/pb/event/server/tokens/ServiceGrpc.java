...
public final class ServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "event.tokens.public.server.v1.Service";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.evemeta.zdk.pb.event.server.tokens.ExtractRequest,
      com.evemeta.zdk.pb.event.server.tokens.ExtractResponse> getExtractMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Extract",
      requestType = com.evemeta.zdk.pb.event.server.tokens.ExtractRequest.class,
      responseType = com.evemeta.zdk.pb.event.server.tokens.ExtractResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.evemeta.zdk.pb.event.server.tokens.ExtractRequest,
      com.evemeta.zdk.pb.event.server.tokens.ExtractResponse> getExtractMethod() {
    io.grpc.MethodDescriptor<com.evemeta.zdk.pb.event.server.tokens.ExtractRequest, com.evemeta.zdk.pb.event.server.tokens.ExtractResponse> getExtractMethod;
    if ((getExtractMethod = ServiceGrpc.getExtractMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getExtractMethod = ServiceGrpc.getExtractMethod) == null) {
          ServiceGrpc.getExtractMethod = getExtractMethod =
              io.grpc.MethodDescriptor.<com.evemeta.zdk.pb.event.server.tokens.ExtractRequest, com.evemeta.zdk.pb.event.server.tokens.ExtractResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Extract"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.evemeta.zdk.pb.event.server.tokens.ExtractRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.evemeta.zdk.pb.event.server.tokens.ExtractResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void extract(com.evemeta.zdk.pb.event.server.tokens.ExtractRequest request,
        io.grpc.stub.StreamObserver<com.evemeta.zdk.pb.event.server.tokens.ExtractResponse> responseObserver) {
  ...
  public static final class ServiceStub
    ...
    /**
     */
    public void extract(com.evemeta.zdk.pb.event.server.tokens.ExtractRequest request,
        io.grpc.stub.StreamObserver<com.evemeta.zdk.pb.event.server.tokens.ExtractResponse> responseObserver) {
  ...
  public static final class ServiceBlockingV2Stub
    ...
    /**
     */
    public com.evemeta.zdk.pb.event.server.tokens.ExtractResponse extract(com.evemeta.zdk.pb.event.server.tokens.ExtractRequest request) throws io.grpc.StatusException {
  ...
  public static final class ServiceBlockingStub
    ...
    /**
     */
    public com.evemeta.zdk.pb.event.server.tokens.ExtractResponse extract(com.evemeta.zdk.pb.event.server.tokens.ExtractRequest request) {
  ...
  public static final class ServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.evemeta.zdk.pb.event.server.tokens.ExtractResponse> extract(
        com.evemeta.zdk.pb.event.server.tokens.ExtractRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXTRACT:
          serviceImpl.extract((com.evemeta.zdk.pb.event.server.tokens.ExtractRequest) request,
              (io.grpc.stub.StreamObserver<com.evemeta.zdk.pb.event.server.tokens.ExtractResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.evemeta.zdk.pb.event.server.tokens.ExtractRequest,
              com.evemeta.zdk.pb.event.server.tokens.ExtractResponse>(
  ...
  private static abstract class ServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.evemeta.zdk.pb.event.server.tokens.Services.getDescriptor();
    }
