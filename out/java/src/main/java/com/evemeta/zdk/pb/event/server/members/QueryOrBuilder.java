...
public interface QueryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:event.members.public.server.v1.Query)
   ...
   * @return The order.
   */
  com.evemeta.zdk.pb.event.server.members.Order getOrder();
   ...
   */
  com.evemeta.zdk.pb.event.server.members.Condition getCondition();
  /**
   * <pre>
   * Represents the set of conditions that filter the data retrieval process.
   * </pre>
   ...
   * <code>.event.members.public.server.v1.Condition condition = 4;</code>
   */
  com.evemeta.zdk.pb.event.server.members.ConditionOrBuilder getConditionOrBuilder();
}
