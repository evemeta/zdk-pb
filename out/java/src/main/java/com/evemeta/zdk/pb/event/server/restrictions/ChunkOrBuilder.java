...
public interface ChunkOrBuilder extends
    // @@protoc_insertion_point(interface_extends:event.restrictions.public.server.v1.Chunk)
   ...
   * <code>repeated .event.restrictions.public.server.v1.Restriction entities = 4;</code>
   */
  com.evemeta.zdk.pb.event.server.restrictions.Restriction getEntities(int index);
  /**
   * <pre>
   * Represents the actual restrictions included in this chunk.
   * </pre>
   ...
   * <code>repeated .event.restrictions.public.server.v1.Restriction entities = 4;</code>
   */
  com.evemeta.zdk.pb.event.server.restrictions.RestrictionOrBuilder getEntitiesOrBuilder(
      int index);
}
