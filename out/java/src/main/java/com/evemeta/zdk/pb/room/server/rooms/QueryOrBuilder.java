...
public interface QueryOrBuilder extends
   ...
   * @return The order.
   */
  com.evemeta.zdk.pb.room.server.rooms.Order getOrder();
   ...
   */
  com.evemeta.zdk.pb.room.server.rooms.Condition getCondition();
  /**
   * <pre>
   * Represents the set of conditions that filter the data retrieval process.
   * </pre>
   ...
   * <code>.room.rooms.public.server.v1.Condition condition = 4;</code>
   */
  com.evemeta.zdk.pb.room.server.rooms.ConditionOrBuilder getConditionOrBuilder();
}
