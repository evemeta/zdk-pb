...
public interface QueryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chat.chats.public.server.v1.Query)
   ...
   * @return The order.
   */
  com.evemeta.zdk.pb.chat.server.chats.Order getOrder();
   ...
   */
  com.evemeta.zdk.pb.chat.server.chats.Condition getCondition();
  /**
   * <pre>
   * Represents the set of conditions that filter the data retrieval process.
   * </pre>
   ...
   * <code>.chat.chats.public.server.v1.Condition condition = 4;</code>
   */
  com.evemeta.zdk.pb.chat.server.chats.ConditionOrBuilder getConditionOrBuilder();
}
