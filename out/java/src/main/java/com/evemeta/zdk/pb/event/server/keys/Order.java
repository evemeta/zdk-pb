 ...
 * </pre>
 *
 * Protobuf enum {@code event.keys.public.server.v1.Order}
 */
public enum Order
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return com.evemeta.zdk.pb.event.server.keys.Enums.getDescriptor().getEnumTypes().get(0);
  }
  ...
  // @@protoc_insertion_point(enum_scope:event.keys.public.server.v1.Order)
}
