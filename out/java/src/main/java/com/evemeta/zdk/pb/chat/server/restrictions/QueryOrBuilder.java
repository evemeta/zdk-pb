...
public interface QueryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chat.restrictions.public.server.v1.Query)
   ...
   * @return The order.
   */
  com.evemeta.zdk.pb.chat.server.restrictions.Order getOrder();
   ...
   */
  com.evemeta.zdk.pb.chat.server.restrictions.Condition getCondition();
  /**
   * <pre>
   * Represents the set of conditions that filter the data retrieval process.
   * </pre>
   ...
   * <code>.chat.restrictions.public.server.v1.Condition condition = 4;</code>
   */
  com.evemeta.zdk.pb.chat.server.restrictions.ConditionOrBuilder getConditionOrBuilder();
}
