...
public interface QueryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:event.events.public.server.v1.Query)
   ...
   * @return The order.
   */
  com.evemeta.zdk.pb.event.server.events.Order getOrder();
   ...
   */
  com.evemeta.zdk.pb.event.server.events.Condition getCondition();
  /**
   * <pre>
   * Represents the set of conditions that filter the data retrieval process.
   * </pre>
   ...
   * <code>.event.events.public.server.v1.Condition condition = 4;</code>
   */
  com.evemeta.zdk.pb.event.server.events.ConditionOrBuilder getConditionOrBuilder();
}
