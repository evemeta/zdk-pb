...
public interface ChunkOrBuilder extends
    // @@protoc_insertion_point(interface_extends:event.members.public.server.v1.Chunk)
   ...
   * <code>repeated .event.members.public.server.v1.Member entities = 4;</code>
   */
  com.evemeta.zdk.pb.event.server.members.Member getEntities(int index);
  /**
   * <pre>
   * Represents the actual members included in this chunk.
   * </pre>
   ...
   * <code>repeated .event.members.public.server.v1.Member entities = 4;</code>
   */
  com.evemeta.zdk.pb.event.server.members.MemberOrBuilder getEntitiesOrBuilder(
      int index);
}
