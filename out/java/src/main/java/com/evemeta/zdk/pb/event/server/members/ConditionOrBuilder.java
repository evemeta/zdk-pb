...
public interface ConditionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:event.members.public.server.v1.Condition)
   ...
   */
  java.util.List<com.evemeta.zdk.pb.event.server.members.Status> getStatusesList();
  /**
   * <pre>
   * todo;
   * </pre>
   ...
   */
  com.evemeta.zdk.pb.event.server.members.Status getStatuses(int index);
  /**
   * <pre>
   * todo;
   * </pre>
