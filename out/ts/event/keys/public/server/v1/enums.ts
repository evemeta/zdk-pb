...
// @generated from protobuf file "event/keys/public/server/v1/enums.proto" (package "event.keys.public.server.v1", syntax proto3)
// tslint:disable
/**
 * Order represents an enumeration that specifies the sort order for data retrieval, particularly in the context of querying.
 *
 * @generated from protobuf enum event.keys.public.server.v1.Order
 */
export enum Order {
    /**
