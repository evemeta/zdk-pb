...
// @generated from protobuf file "event/members/public/server/v1/entities.proto" (package "event.members.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message event.members.public.server.v1.Chunk
 */
export interface Chunk {
     ...
     *
     * @generated from protobuf field: repeated event.members.public.server.v1.Member entities = 4;
     */
    entities: Member[];
}
/**
 ...
 *
 * @generated from protobuf message event.members.public.server.v1.Query
 */
export interface Query {
    /**
     * Represents the order in which results should be retrieved.
     *
     * @generated from protobuf field: event.members.public.server.v1.Order order = 1;
     */
    order: Order;
    /**
     ...
     *
     * @generated from protobuf field: event.members.public.server.v1.Condition condition = 4;
     */
    condition?: Condition;
}
/**
 ...
 *
 * @generated from protobuf message event.members.public.server.v1.Member
 */
export interface Member {
     ...
     *
     * @generated from protobuf field: repeated event.members.public.server.v1.Permission permissions = 5;
     */
 ...
 *
 * @generated from protobuf message event.members.public.server.v1.Condition
 */
export interface Condition {
     ...
     *
     * @generated from protobuf field: repeated string event_ids = 2;
     */
    eventIds: string[];
    /**
     * todo;
     *
     * @generated from protobuf field: repeated event.members.public.server.v1.Status statuses = 3;
     */
    statuses: Status[];
}
/**
 ...
 *
 * @generated from protobuf message event.members.public.server.v1.Timeframe
 */
...
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("event.members.public.server.v1.Chunk", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total */ 3:
                    ...
                    break;
                case /* repeated event.members.public.server.v1.Member entities */ 4:
    ...
    internalBinaryWrite(message: Chunk, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated event.members.public.server.v1.Member entities = 4; */
...
/**
 * @generated MessageType for protobuf message event.members.public.server.v1.Chunk
 */
export const Chunk = new Chunk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Query$Type extends MessageType<Query> {
    constructor() {
        super("event.members.public.server.v1.Query", [
            { no: 1, name: "order", kind: "enum", T: () => ["event.members.public.server.v1.Order", Order] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Query): Query {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* event.members.public.server.v1.Order order */ 1:
                ...
                case /* int64 offset */ 3:
                    ...
                    break;
                case /* event.members.public.server.v1.Condition condition */ 4:
    ...
    internalBinaryWrite(message: Query, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* event.members.public.server.v1.Order order = 1; */
        if (message.order !== 0)
        ...
        /* event.members.public.server.v1.Condition condition = 4; */
...
/**
 * @generated MessageType for protobuf message event.members.public.server.v1.Query
 */
export const Query = new Query$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Member$Type extends MessageType<Member> {
    constructor() {
        super("event.members.public.server.v1.Member", [
            ...
            { no: 5, name: "permissions", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["event.members.public.server.v1.Permission", Permission] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, string> metadata */ 4:
                    ...
                    break;
                case /* repeated event.members.public.server.v1.Permission permissions */ 5:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field event.members.public.server.v1.Member.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message event.members.public.server.v1.Member
 */
export const Member = new Member$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Condition$Type extends MessageType<Condition> {
    constructor() {
        super("event.members.public.server.v1.Condition", [
            { no: 1, name: "ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "event_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "statuses", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["event.members.public.server.v1.Status", Status] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated string ids */ 1:
                    ...
                    break;
                case /* repeated string event_ids */ 2:
                    message.eventIds.push(reader.string());
                    break;
                case /* repeated event.members.public.server.v1.Status statuses */ 3:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
    ...
    internalBinaryWrite(message: Condition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.eventIds.length; i++)
            writer.tag(2, WireType.LengthDelimited).string(message.eventIds[i]);
...
/**
 * @generated MessageType for protobuf message event.members.public.server.v1.Condition
 */
export const Condition = new Condition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Timeframe$Type extends MessageType<Timeframe> {
    constructor() {
        super("event.members.public.server.v1.Timeframe", [
...
/**
 * @generated MessageType for protobuf message event.members.public.server.v1.Timeframe
 */
