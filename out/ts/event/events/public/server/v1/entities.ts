...
import { McuSourceAudioOutput } from "./enums";
import { McuSourceVideoOutput } from "./enums";
import { McuSourceOrientation } from "./enums";
...
export interface Event {
     ...
     *
     * @generated from protobuf field: event.events.public.server.v1.Source source = 4;
     */
    source?: Source;
    /**
     ...
     *
     * @generated from protobuf field: event.events.public.server.v1.Schedule schedule = 6;
     */
    schedule: Schedule;
    /**
 ...
 *
 * @generated from protobuf message event.events.public.server.v1.Source
 */
export interface Source {
     ...
     */
    source: {
        oneofKind: "mcuStreamerSource";
        /**
         * Represents a source provided by an MCU streamer instance.
         *
         * @generated from protobuf field: event.events.public.server.v1.McuStreamerSource mcu_streamer_source = 1;
         */
        mcuStreamerSource: McuStreamerSource;
    } | {
        oneofKind: "mcuRoomSource";
        /**
         * Represents a source provided by an MCU room instance.
         *
         * @generated from protobuf field: event.events.public.server.v1.McuRoomSource mcu_room_source = 2;
         */
        mcuRoomSource: McuRoomSource;
    } | {
        oneofKind: "dashSource";
        /**
         * Represents a source delivered through an external DASH stream.
         *
         * @generated from protobuf field: event.events.public.server.v1.DashSource dash_source = 3;
         */
 ...
 *
 * @generated from protobuf message event.events.public.server.v1.McuStreamerSource
 */
export interface McuStreamerSource {
    /**
     * Represents the orientation of the stream generated by the MCU.
     *
     * @generated from protobuf field: event.events.public.server.v1.McuSourceOrientation orientation = 1;
     */
    orientation: McuSourceOrientation;
    /**
     * Represents the video output profile used by the MCU for the stream.
     *
     * @generated from protobuf field: repeated event.events.public.server.v1.McuSourceVideoOutput video_outputs = 2;
     */
    videoOutputs: McuSourceVideoOutput[];
    /**
     * Represents the audio output profile used by the MCU for the stream.
     *
     * @generated from protobuf field: repeated event.events.public.server.v1.McuSourceAudioOutput audio_outputs = 3;
     */
    audioOutputs: McuSourceAudioOutput[];
}
/**
 * McuRoomSource represents a media source produced by an MCU room.
 * It defines the configuration used by the MCU when generating the media stream
 *
 * @generated from protobuf message event.events.public.server.v1.McuRoomSource
 */
export interface McuRoomSource {
    /**
     * Represents the orientation of the stream generated by the MCU.
     *
     * @generated from protobuf field: event.events.public.server.v1.McuSourceOrientation orientation = 1;
 ...
 *
 * @generated from protobuf message event.events.public.server.v1.DashSource
 */
...
class Event$Type extends MessageType<Event> {
    constructor() {
        super("event.events.public.server.v1.Event", [
            ...
            { no: 6, name: "schedule", kind: "enum", T: () => ["event.events.public.server.v1.Schedule", Schedule] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* event.events.public.server.v1.Status status */ 3:
                    ...
                    break;
                case /* event.events.public.server.v1.Source source */ 4:
                ...
                case /* map<string, string> metadata */ 5:
                    ...
                    break;
                case /* event.events.public.server.v1.Schedule schedule */ 6:
    ...
    private binaryReadMap5(map: Event["metadata"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: Event, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.source)
            Source.internalBinaryWrite(message.source, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.schedule !== 0)
            writer.tag(6, WireType.Varint).int32(message.schedule);
...
class Source$Type extends MessageType<Source> {
    constructor() {
        super("event.events.public.server.v1.Source", [
            { no: 1, name: "mcu_streamer_source", kind: "message", oneof: "source", T: () => McuStreamerSource },
            { no: 2, name: "mcu_room_source", kind: "message", oneof: "source", T: () => McuRoomSource },
            { no: 3, name: "dash_source", kind: "message", oneof: "source", T: () => DashSource }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Source): Source {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* event.events.public.server.v1.McuStreamerSource mcu_streamer_source */ 1:
                    message.source = {
                        oneofKind: "mcuStreamerSource",
                        mcuStreamerSource: McuStreamerSource.internalBinaryRead(reader, reader.uint32(), options, (message.source as any).mcuStreamerSource)
                    };
                    break;
                case /* event.events.public.server.v1.McuRoomSource mcu_room_source */ 2:
                    message.source = {
                        oneofKind: "mcuRoomSource",
                        mcuRoomSource: McuRoomSource.internalBinaryRead(reader, reader.uint32(), options, (message.source as any).mcuRoomSource)
                    };
                    break;
                case /* event.events.public.server.v1.DashSource dash_source */ 3:
                    message.source = {
                        oneofKind: "dashSource",
                        dashSource: DashSource.internalBinaryRead(reader, reader.uint32(), options, (message.source as any).dashSource)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Source, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.source.oneofKind === "mcuStreamerSource")
            McuStreamerSource.internalBinaryWrite(message.source.mcuStreamerSource, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* event.events.public.server.v1.McuRoomSource mcu_room_source = 2; */
        if (message.source.oneofKind === "mcuRoomSource")
            McuRoomSource.internalBinaryWrite(message.source.mcuRoomSource, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* event.events.public.server.v1.DashSource dash_source = 3; */
        if (message.source.oneofKind === "dashSource")
            DashSource.internalBinaryWrite(message.source.dashSource, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message event.events.public.server.v1.Source
 */
export const Source = new Source$Type();
// @generated message type with reflection information, may provide speed optimized methods
class McuStreamerSource$Type extends MessageType<McuStreamerSource> {
    constructor() {
        super("event.events.public.server.v1.McuStreamerSource", [
            { no: 1, name: "orientation", kind: "enum", T: () => ["event.events.public.server.v1.McuSourceOrientation", McuSourceOrientation] },
            { no: 2, name: "video_outputs", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["event.events.public.server.v1.McuSourceVideoOutput", McuSourceVideoOutput] },
            { no: 3, name: "audio_outputs", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["event.events.public.server.v1.McuSourceAudioOutput", McuSourceAudioOutput] }
        ]);
    }
    create(value?: PartialMessage<McuStreamerSource>): McuStreamerSource {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.orientation = 0;
        message.videoOutputs = [];
        message.audioOutputs = [];
        if (value !== undefined)
            reflectionMergePartial<McuStreamerSource>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: McuStreamerSource): McuStreamerSource {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* event.events.public.server.v1.McuSourceOrientation orientation */ 1:
                    message.orientation = reader.int32();
                    break;
                case /* repeated event.events.public.server.v1.McuSourceVideoOutput video_outputs */ 2:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.videoOutputs.push(reader.int32());
                    else
                        message.videoOutputs.push(reader.int32());
                    break;
                case /* repeated event.events.public.server.v1.McuSourceAudioOutput audio_outputs */ 3:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.audioOutputs.push(reader.int32());
                    else
                        message.audioOutputs.push(reader.int32());
                    break;
                default:
    ...
    internalBinaryWrite(message: McuStreamerSource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.videoOutputs.length) {
            writer.tag(2, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.videoOutputs.length; i++)
                writer.int32(message.videoOutputs[i]);
            writer.join();
        }
        /* repeated event.events.public.server.v1.McuSourceAudioOutput audio_outputs = 3; */
        if (message.audioOutputs.length) {
            writer.tag(3, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.audioOutputs.length; i++)
                writer.int32(message.audioOutputs[i]);
            writer.join();
        }
        let u = options.writeUnknownFields;
        if (u !== false)
...
/**
 * @generated MessageType for protobuf message event.events.public.server.v1.McuStreamerSource
 */
export const McuStreamerSource = new McuStreamerSource$Type();
// @generated message type with reflection information, may provide speed optimized methods
class McuRoomSource$Type extends MessageType<McuRoomSource> {
    constructor() {
        super("event.events.public.server.v1.McuRoomSource", [
            { no: 1, name: "orientation", kind: "enum", T: () => ["event.events.public.server.v1.McuSourceOrientation", McuSourceOrientation] },
            { no: 2, name: "video_outputs", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["event.events.public.server.v1.McuSourceVideoOutput", McuSourceVideoOutput] },
            { no: 3, name: "audio_outputs", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["event.events.public.server.v1.McuSourceAudioOutput", McuSourceAudioOutput] }
        ]);
    }
    create(value?: PartialMessage<McuRoomSource>): McuRoomSource {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.orientation = 0;
        message.videoOutputs = [];
        message.audioOutputs = [];
        if (value !== undefined)
            reflectionMergePartial<McuRoomSource>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: McuRoomSource): McuRoomSource {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: McuRoomSource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* event.events.public.server.v1.McuSourceOrientation orientation = 1; */
        if (message.orientation !== 0)
            writer.tag(1, WireType.Varint).int32(message.orientation);
        /* repeated event.events.public.server.v1.McuSourceVideoOutput video_outputs = 2; */
...
/**
 * @generated MessageType for protobuf message event.events.public.server.v1.McuRoomSource
 */
export const McuRoomSource = new McuRoomSource$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DashSource$Type extends MessageType<DashSource> {
    constructor() {
        super("event.events.public.server.v1.DashSource", [
            { no: 1, name: "url", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<DashSource>): DashSource {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.url = "";
        if (value !== undefined)
            reflectionMergePartial<DashSource>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DashSource): DashSource {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DashSource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string url = 1; */
        if (message.url !== "")
...
/**
 * @generated MessageType for protobuf message event.events.public.server.v1.DashSource
 */
export const DashSource = new DashSource$Type();
// @generated message type with reflection information, may provide speed optimized methods
