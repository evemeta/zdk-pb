...
// @generated from protobuf file "event/restrictions/public/server/v1/entities.proto" (package "event.restrictions.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.Chunk
 */
export interface Chunk {
     ...
     *
     * @generated from protobuf field: repeated event.restrictions.public.server.v1.Restriction entities = 4;
     */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.Query
 */
export interface Query {
    /**
     * Represents the order in which results should be retrieved.
     *
     * @generated from protobuf field: event.restrictions.public.server.v1.Order order = 1;
     */
    order: Order;
    /**
     ...
     *
     * @generated from protobuf field: event.restrictions.public.server.v1.Condition condition = 4;
     */
    condition?: Condition;
}
/**
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.Timeframe
 */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.Condition
 */
export interface Condition {
     ...
     *
     * @generated from protobuf field: repeated string event_ids = 3;
     */
    eventIds: string[];
}
/**
 * Restriction todo;
 *
 * @generated from protobuf message event.restrictions.public.server.v1.Restriction
 */
export interface Restriction {
    ...
    eventId: string;
    /**
     * @generated from protobuf field: event.restrictions.public.server.v1.Kind kind = 4;
     */
    kind: Kind;
    /**
...
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("event.restrictions.public.server.v1.Chunk", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total */ 3:
                    ...
                    break;
                case /* repeated event.restrictions.public.server.v1.Restriction entities */ 4:
    ...
    internalBinaryWrite(message: Chunk, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated event.restrictions.public.server.v1.Restriction entities = 4; */
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.Chunk
 */
export const Chunk = new Chunk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Query$Type extends MessageType<Query> {
    constructor() {
        super("event.restrictions.public.server.v1.Query", [
            { no: 1, name: "order", kind: "enum", T: () => ["event.restrictions.public.server.v1.Order", Order] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Query): Query {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* event.restrictions.public.server.v1.Order order */ 1:
                ...
                case /* int64 offset */ 3:
                    ...
                    break;
                case /* event.restrictions.public.server.v1.Condition condition */ 4:
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.Query
 */
export const Query = new Query$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Timeframe$Type extends MessageType<Timeframe> {
    constructor() {
        super("event.restrictions.public.server.v1.Timeframe", [
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.Timeframe
 */
export const Timeframe = new Timeframe$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Condition$Type extends MessageType<Condition> {
    constructor() {
        super("event.restrictions.public.server.v1.Condition", [
            ...
            { no: 3, name: "event_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated string user_ids */ 2:
                    ...
                    break;
                case /* repeated string event_ids */ 3:
    ...
    internalBinaryWrite(message: Condition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.eventIds.length; i++)
            writer.tag(3, WireType.LengthDelimited).string(message.eventIds[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.Condition
 */
export const Condition = new Condition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Restriction$Type extends MessageType<Restriction> {
    constructor() {
        super("event.restrictions.public.server.v1.Restriction", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "event_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "kind", kind: "enum", T: () => ["event.restrictions.public.server.v1.Kind", Kind] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string event_id */ 3:
                    ...
                    break;
                case /* event.restrictions.public.server.v1.Kind kind */ 4:
    ...
    internalBinaryWrite(message: Restriction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* event.restrictions.public.server.v1.Kind kind = 4; */
        if (message.kind !== 0)
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.Restriction
 */
