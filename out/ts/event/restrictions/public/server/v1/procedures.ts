...
// @generated from protobuf file "event/restrictions/public/server/v1/procedures.proto" (package "event.restrictions.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.CountRequest
 */
export interface CountRequest {
    /**
     * Represents the specifications and conditions under which restrictions should be counted.
     *
     * @generated from protobuf field: event.restrictions.public.server.v1.Query query = 1;
     */
    query?: Query;
}
/**
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.CountResponse
 */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.SelectRequest
 */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.SelectResponse
 */
export interface SelectResponse {
    /**
     * Represents a list of restrictions that match the criteria of the given query.
     *
     * @generated from protobuf field: repeated event.restrictions.public.server.v1.Restriction restrictions = 1;
     */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.RangeRequest
 */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.RangeResponse
 */
export interface RangeResponse {
    /**
     * Represents a chunk of restrictions that match the criteria of the given query.
     *
     * @generated from protobuf field: event.restrictions.public.server.v1.Chunk chunk = 1;
     */
    chunk?: Chunk;
}
/**
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.CreateRequest
 */
export interface CreateRequest {
     ...
     * todo;
     *
     * @generated from protobuf field: event.restrictions.public.server.v1.Kind kind = 3;
     */
    kind: Kind;
    /**
     * todo;
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.CreateResponse
 */
export interface CreateResponse {
    /**
     * Represents the comprehensive details of the created restriction.
     *
     * @generated from protobuf field: event.restrictions.public.server.v1.Restriction restriction = 1;
     */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.DeleteRequest
 */
 ...
 *
 * @generated from protobuf message event.restrictions.public.server.v1.DeleteResponse
 */
...
class CountRequest$Type extends MessageType<CountRequest> {
    constructor() {
        super("event.restrictions.public.server.v1.CountRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CountRequest): CountRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* event.restrictions.public.server.v1.Query query */ 1:
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.CountRequest
 */
export const CountRequest = new CountRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CountResponse$Type extends MessageType<CountResponse> {
    constructor() {
        super("event.restrictions.public.server.v1.CountResponse", [
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.CountResponse
 */
export const CountResponse = new CountResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SelectRequest$Type extends MessageType<SelectRequest> {
    constructor() {
        super("event.restrictions.public.server.v1.SelectRequest", [
            { no: 1, name: "query", kind: "message", T: () => Query }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.SelectRequest
 */
...
class SelectResponse$Type extends MessageType<SelectResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SelectResponse): SelectResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated event.restrictions.public.server.v1.Restriction restrictions */ 1:
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.SelectResponse
 */
export const SelectResponse = new SelectResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeRequest$Type extends MessageType<RangeRequest> {
    constructor() {
        super("event.restrictions.public.server.v1.RangeRequest", [
            { no: 1, name: "query", kind: "message", T: () => Query }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.RangeRequest
 */
export const RangeRequest = new RangeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeResponse$Type extends MessageType<RangeResponse> {
    constructor() {
        super("event.restrictions.public.server.v1.RangeResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RangeResponse): RangeResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* event.restrictions.public.server.v1.Chunk chunk */ 1:
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.RangeResponse
 */
export const RangeResponse = new RangeResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateRequest$Type extends MessageType<CreateRequest> {
    constructor() {
        super("event.restrictions.public.server.v1.CreateRequest", [
            { no: 1, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "event_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "kind", kind: "enum", T: () => ["event.restrictions.public.server.v1.Kind", Kind] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string event_id */ 2:
                    ...
                    break;
                case /* event.restrictions.public.server.v1.Kind kind */ 3:
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.CreateRequest
 */
export const CreateRequest = new CreateRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateResponse$Type extends MessageType<CreateResponse> {
    constructor() {
        super("event.restrictions.public.server.v1.CreateResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateResponse): CreateResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* event.restrictions.public.server.v1.Restriction restriction */ 1:
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.CreateResponse
 */
export const CreateResponse = new CreateResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteRequest$Type extends MessageType<DeleteRequest> {
    constructor() {
        super("event.restrictions.public.server.v1.DeleteRequest", [
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.DeleteRequest
 */
export const DeleteRequest = new DeleteRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteResponse$Type extends MessageType<DeleteResponse> {
    constructor() {
        super("event.restrictions.public.server.v1.DeleteResponse", [
            { no: 1, name: "restriction", kind: "message", T: () => Restriction }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message event.restrictions.public.server.v1.DeleteResponse
 */
