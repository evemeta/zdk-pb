...
/**
 * @generated from protobuf service event.restrictions.public.server.v1.Service
 */
export interface IServiceClient {
    /**
     * Count represents a procedure that retrieves the total number of restrictions based on a specific query.
     *
     * @generated from protobuf rpc: Count(event.restrictions.public.server.v1.CountRequest) returns (event.restrictions.public.server.v1.CountResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Range(event.restrictions.public.server.v1.RangeRequest) returns (event.restrictions.public.server.v1.RangeResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Select(event.restrictions.public.server.v1.SelectRequest) returns (event.restrictions.public.server.v1.SelectResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Create(event.restrictions.public.server.v1.CreateRequest) returns (event.restrictions.public.server.v1.CreateResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Delete(event.restrictions.public.server.v1.DeleteRequest) returns (event.restrictions.public.server.v1.DeleteResponse);
     */
