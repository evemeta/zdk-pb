...
// @generated from protobuf file "room/members/public/server/v1/entities.proto" (package "members.public.server.v1", syntax proto3)
// tslint:disable
...
export interface Member {
     ...
     * todo;
     *
     * @generated from protobuf field: repeated members.public.server.v1.Capability capabilities = 5;
     */
     ...
     * todo;
     *
     * @generated from protobuf field: members.public.server.v1.Connection sender_connection = 7;
     */
    senderConnection?: Connection;
    /**
     * todo;
     *
     * @generated from protobuf field: members.public.server.v1.Connection receiver_connection = 8;
     */
     ...
     *
     * @generated from protobuf field: int64 update_time = 10;
     */
    updateTime: bigint;
}
/**
 ...
 * Connection todo;
 *
 * @generated from protobuf message members.public.server.v1.Connection
 */
export interface Connection {
    /**
     * todo;
     *
     * @generated from protobuf field: members.public.server.v1.ConnectionStatus status = 1;
     */
...
class Member$Type extends MessageType<Member> {
    constructor() {
        super("members.public.server.v1.Member", [
            ...
            { no: 5, name: "capabilities", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["members.public.server.v1.Capability", Capability] },
            { no: 6, name: "restrictions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Restriction },
            { no: 7, name: "sender_connection", kind: "message", T: () => Connection },
            { no: 8, name: "receiver_connection", kind: "message", T: () => Connection },
            { no: 9, name: "create_time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 10, name: "update_time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<Member>): Member {
        const message = { id: "", userId: "", roomId: "", metadata: {}, capabilities: [], restrictions: [], createTime: 0n, updateTime: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, string> metadata */ 4:
                    ...
                    break;
                case /* repeated members.public.server.v1.Capability capabilities */ 5:
                ...
                case /* repeated members.public.server.v1.Restriction restrictions */ 6:
                    ...
                    break;
                case /* members.public.server.v1.Connection sender_connection */ 7:
                    message.senderConnection = Connection.internalBinaryRead(reader, reader.uint32(), options, message.senderConnection);
                    break;
                case /* members.public.server.v1.Connection receiver_connection */ 8:
                    message.receiverConnection = Connection.internalBinaryRead(reader, reader.uint32(), options, message.receiverConnection);
                    break;
                case /* int64 create_time */ 9:
                    message.createTime = reader.int64().toBigInt();
                    break;
                case /* int64 update_time */ 10:
    ...
    internalBinaryWrite(message: Member, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated members.public.server.v1.Capability capabilities = 5; */
        ...
        /* members.public.server.v1.Connection sender_connection = 7; */
        if (message.senderConnection)
            Connection.internalBinaryWrite(message.senderConnection, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        /* members.public.server.v1.Connection receiver_connection = 8; */
        if (message.receiverConnection)
            Connection.internalBinaryWrite(message.receiverConnection, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* int64 create_time = 9; */
        if (message.createTime !== 0n)
            writer.tag(9, WireType.Varint).int64(message.createTime);
        /* int64 update_time = 10; */
        if (message.updateTime !== 0n)
            writer.tag(10, WireType.Varint).int64(message.updateTime);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Connection$Type extends MessageType<Connection> {
    constructor() {
        super("members.public.server.v1.Connection", [
            { no: 1, name: "status", kind: "enum", T: () => ["members.public.server.v1.ConnectionStatus", ConnectionStatus] }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Connection): Connection {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* members.public.server.v1.ConnectionStatus status */ 1:
    ...
    internalBinaryWrite(message: Connection, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* members.public.server.v1.ConnectionStatus status = 1; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message members.public.server.v1.Connection
 */
