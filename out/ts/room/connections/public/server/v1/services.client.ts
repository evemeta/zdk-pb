...
/**
 * @generated from protobuf service room.connections.public.server.v1.Service
 */
export interface IServiceClient {
    /**
     * Count represents a procedure that retrieves the total number of connections based on a specific query.
     *
     * @generated from protobuf rpc: Count(room.connections.public.server.v1.CountRequest) returns (room.connections.public.server.v1.CountResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Range(room.connections.public.server.v1.RangeRequest) returns (room.connections.public.server.v1.RangeResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Select(room.connections.public.server.v1.SelectRequest) returns (room.connections.public.server.v1.SelectResponse);
     */
