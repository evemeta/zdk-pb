...
// @generated from protobuf file "room/connections/public/server/v1/entities.proto" (package "room.connections.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message room.connections.public.server.v1.Chunk
 */
export interface Chunk {
     ...
     *
     * @generated from protobuf field: repeated room.connections.public.server.v1.Connection entities = 4;
     */
    entities: Connection[];
}
/**
 ...
 *
 * @generated from protobuf message room.connections.public.server.v1.Query
 */
export interface Query {
    /**
     * Represents the order in which results should be retrieved.
     *
     * @generated from protobuf field: room.connections.public.server.v1.Order order = 1;
     */
    order: Order;
    /**
     ...
     *
     * @generated from protobuf field: room.connections.public.server.v1.Condition condition = 4;
     */
    condition?: Condition;
}
/**
 ...
 *
 * @generated from protobuf message room.connections.public.server.v1.Condition
 */
 ...
 *
 * @generated from protobuf message room.connections.public.server.v1.Timeframe
 */
 ...
 * Connection todo;
 *
 * @generated from protobuf message room.connections.public.server.v1.Connection
 */
export interface Connection {
    ...
    roomId: string;
    /**
     * @generated from protobuf field: room.connections.public.server.v1.Kind kind = 4;
     */
    kind: Kind;
    /**
     * @generated from protobuf field: room.connections.public.server.v1.Status status = 5;
     */
    status: Status;
    /**
...
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("room.connections.public.server.v1.Chunk", [
            ...
            { no: 4, name: "entities", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Connection }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total */ 3:
                    ...
                    break;
                case /* repeated room.connections.public.server.v1.Connection entities */ 4:
                    message.entities.push(Connection.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message: Chunk, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.entities.length; i++)
            Connection.internalBinaryWrite(message.entities[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message room.connections.public.server.v1.Chunk
 */
export const Chunk = new Chunk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Query$Type extends MessageType<Query> {
    constructor() {
        super("room.connections.public.server.v1.Query", [
            { no: 1, name: "order", kind: "enum", T: () => ["room.connections.public.server.v1.Order", Order] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Query): Query {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* room.connections.public.server.v1.Order order */ 1:
                ...
                case /* int64 offset */ 3:
                    ...
                    break;
                case /* room.connections.public.server.v1.Condition condition */ 4:
    ...
    internalBinaryWrite(message: Query, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* room.connections.public.server.v1.Order order = 1; */
        if (message.order !== 0)
        ...
        /* room.connections.public.server.v1.Condition condition = 4; */
...
/**
 * @generated MessageType for protobuf message room.connections.public.server.v1.Query
 */
export const Query = new Query$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Condition$Type extends MessageType<Condition> {
    constructor() {
        super("room.connections.public.server.v1.Condition", [
...
/**
 * @generated MessageType for protobuf message room.connections.public.server.v1.Condition
 */
export const Condition = new Condition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Timeframe$Type extends MessageType<Timeframe> {
    constructor() {
        super("room.connections.public.server.v1.Timeframe", [
...
/**
 * @generated MessageType for protobuf message room.connections.public.server.v1.Timeframe
 */
export const Timeframe = new Timeframe$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Connection$Type extends MessageType<Connection> {
    constructor() {
        super("room.connections.public.server.v1.Connection", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "room_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "kind", kind: "enum", T: () => ["room.connections.public.server.v1.Kind", Kind] },
            { no: 5, name: "status", kind: "enum", T: () => ["room.connections.public.server.v1.Status", Status] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string room_id */ 3:
                    ...
                    break;
                case /* room.connections.public.server.v1.Kind kind */ 4:
                    message.kind = reader.int32();
                    break;
                case /* room.connections.public.server.v1.Status status */ 5:
...
/**
 * @generated MessageType for protobuf message room.connections.public.server.v1.Connection
 */
