...
export interface Context {
     ...
     * todo;
     *
     * @generated from protobuf field: repeated room.restrictions.public.server.v1.Restriction restrictions = 13;
     */
    restrictions: Restriction[];
    /**
     * todo;
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe restrictions_timeframe = 14;
     */
...
class Context$Type extends MessageType<Context> {
    constructor() {
        super("room.rooms.public.server.v1.Context", [
            ...
            { no: 13, name: "restrictions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Restriction },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* room.rooms.public.server.v1.Timeframe connections_timeframe */ 12:
                    ...
                    break;
                case /* repeated room.restrictions.public.server.v1.Restriction restrictions */ 13:
                    message.restrictions.push(Restriction.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* room.rooms.public.server.v1.Timeframe restrictions_timeframe */ 14:
    ...
    internalBinaryWrite(message: Context, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.restrictions.length; i++)
            Restriction.internalBinaryWrite(message.restrictions[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
