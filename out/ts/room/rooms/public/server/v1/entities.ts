...
// @generated from protobuf file "room/rooms/public/server/v1/entities.proto" (package "room.rooms.public.server.v1", syntax proto3)
// tslint:disable
...
import { Timeframe as Timeframe$ } from "../../../../restrictions/public/server/v1/entities";
import { Connection } from "../../../../connections/public/server/v1/entities";
import { Stream } from "../../../../streams/public/server/v1/entities";
 ...
 *
 * @generated from protobuf message room.rooms.public.server.v1.Room
 */
export interface Room {
     ...
     * todo;
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Kind kind = 2;
     */
    kind: Kind;
    /**
 ...
 *
 * @generated from protobuf message room.rooms.public.server.v1.Chunk
 */
export interface Chunk {
     ...
     *
     * @generated from protobuf field: repeated room.rooms.public.server.v1.Room entities = 4;
     */
    entities: Room[];
}
/**
 ...
 *
 * @generated from protobuf message room.rooms.public.server.v1.Query
 */
export interface Query {
    /**
     * Represents the order in which results should be retrieved.
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Order order = 1;
     */
    order: Order;
    /**
     ...
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Condition condition = 4;
     */
    condition?: Condition;
}
/**
 ...
 *
 * @generated from protobuf message room.rooms.public.server.v1.Context
 */
export interface Context {
     ...
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe room_timeframe = 2;
     */
    roomTimeframe?: Timeframe;
    /**
     * todo;
     *
     ...
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe chat_timeframe = 4;
     */
     ...
     *
     * @generated from protobuf field: room.members.public.server.v1.Member member = 5;
     */
    member?: Member;
    /**
     ...
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe member_timeframe = 6;
     */
    memberTimeframe?: Timeframe;
    /**
     * todo;
     *
     * @generated from protobuf field: repeated room.members.public.server.v1.Member members = 7;
     */
    members: Member[];
    /**
     ...
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe members_timeframe = 8;
     */
    membersTimeframe?: Timeframe;
    /**
     * todo;
     *
     * @generated from protobuf field: repeated room.streams.public.server.v1.Stream streams = 9;
     */
    streams: Stream[];
    /**
     * todo;
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe streams_timeframe = 10;
     */
    streamsTimeframe?: Timeframe;
    /**
     * todo;
     *
     * @generated from protobuf field: repeated room.connections.public.server.v1.Connection connections = 11;
     */
    connections: Connection[];
    /**
     * todo;
     *
     * @generated from protobuf field: room.rooms.public.server.v1.Timeframe connections_timeframe = 12;
     */
    connectionsTimeframe?: Timeframe;
    /**
     * todo;
     *
     * @generated from protobuf field: repeated room.streams.public.server.v1.Stream restrictions = 13;
     */
    restrictions: Stream[];
    /**
     * todo;
     *
     * @generated from protobuf field: room.restrictions.public.server.v1.Timeframe restrictions_timeframe = 14;
     */
 ...
 *
 * @generated from protobuf message room.rooms.public.server.v1.Condition
 */
 ...
 *
 * @generated from protobuf message room.rooms.public.server.v1.Timeframe
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field room.rooms.public.server.v1.Room.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message room.rooms.public.server.v1.Room
 */
export const Room = new Room$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("room.rooms.public.server.v1.Chunk", [
            ...
            { no: 4, name: "entities", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Room }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total */ 3:
                    ...
                    break;
                case /* repeated room.rooms.public.server.v1.Room entities */ 4:
                    message.entities.push(Room.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: Chunk, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.entities.length; i++)
            Room.internalBinaryWrite(message.entities[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message room.rooms.public.server.v1.Chunk
 */
export const Chunk = new Chunk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Query$Type extends MessageType<Query> {
    constructor() {
        super("room.rooms.public.server.v1.Query", [
            { no: 1, name: "order", kind: "enum", T: () => ["room.rooms.public.server.v1.Order", Order] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Query): Query {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* room.rooms.public.server.v1.Order order */ 1:
                ...
                case /* int64 offset */ 3:
                    ...
                    break;
                case /* room.rooms.public.server.v1.Condition condition */ 4:
...
/**
 * @generated MessageType for protobuf message room.rooms.public.server.v1.Query
 */
export const Query = new Query$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Context$Type extends MessageType<Context> {
    constructor() {
        super("room.rooms.public.server.v1.Context", [
            { no: 1, name: "room", kind: "message", T: () => Room },
            { no: 2, name: "room_timeframe", kind: "message", T: () => Timeframe },
            ...
            { no: 9, name: "streams", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Stream },
            { no: 10, name: "streams_timeframe", kind: "message", T: () => Timeframe },
            { no: 11, name: "connections", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Connection },
            { no: 12, name: "connections_timeframe", kind: "message", T: () => Timeframe },
            { no: 13, name: "restrictions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Stream },
            { no: 14, name: "restrictions_timeframe", kind: "message", T: () => Timeframe$ }
        ]);
    }
    create(value?: PartialMessage<Context>): Context {
        const message = { members: [], streams: [], connections: [], restrictions: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* room.rooms.public.server.v1.Room room */ 1:
                    ...
                    break;
                case /* room.rooms.public.server.v1.Timeframe room_timeframe */ 2:
                    message.roomTimeframe = Timeframe.internalBinaryRead(reader, reader.uint32(), options, message.roomTimeframe);
                    break;
    ...
    internalBinaryWrite(message: Context, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.roomTimeframe)
            Timeframe.internalBinaryWrite(message.roomTimeframe, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        ...
        for (let i = 0; i < message.streams.length; i++)
            Stream.internalBinaryWrite(message.streams[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* room.rooms.public.server.v1.Timeframe streams_timeframe = 10; */
        if (message.streamsTimeframe)
            Timeframe.internalBinaryWrite(message.streamsTimeframe, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* repeated room.connections.public.server.v1.Connection connections = 11; */
        for (let i = 0; i < message.connections.length; i++)
            Connection.internalBinaryWrite(message.connections[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* room.rooms.public.server.v1.Timeframe connections_timeframe = 12; */
        if (message.connectionsTimeframe)
            Timeframe.internalBinaryWrite(message.connectionsTimeframe, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* repeated room.streams.public.server.v1.Stream restrictions = 13; */
        for (let i = 0; i < message.restrictions.length; i++)
            Stream.internalBinaryWrite(message.restrictions[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        /* room.restrictions.public.server.v1.Timeframe restrictions_timeframe = 14; */
        if (message.restrictionsTimeframe)
            Timeframe$.internalBinaryWrite(message.restrictionsTimeframe, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message room.rooms.public.server.v1.Context
 */
export const Context = new Context$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Condition$Type extends MessageType<Condition> {
    constructor() {
        super("room.rooms.public.server.v1.Condition", [
...
/**
 * @generated MessageType for protobuf message room.rooms.public.server.v1.Condition
 */
export const Condition = new Condition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Timeframe$Type extends MessageType<Timeframe> {
    constructor() {
        super("room.rooms.public.server.v1.Timeframe", [
...
/**
 * @generated MessageType for protobuf message room.rooms.public.server.v1.Timeframe
 */
