...
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("room.rooms.public.server.v1.Chunk", [
            ...
            { no: 4, name: "entities", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Room }
        ]);
    }
...
class Context$Type extends MessageType<Context> {
    constructor() {
        super("room.rooms.public.server.v1.Context", [
            ...
            { no: 9, name: "streams", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Stream },
            { no: 10, name: "streams_timeframe", kind: "message", T: () => Timeframe },
            { no: 11, name: "connections", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Connection },
            { no: 12, name: "connections_timeframe", kind: "message", T: () => Timeframe },
            { no: 13, name: "restrictions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Restriction },
