...
// @generated from protobuf file "room/rooms/public/server/v1/entities.proto" (package "rooms.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message rooms.public.server.v1.Room
 */
 ...
 *
 * @generated from protobuf message rooms.public.server.v1.Chunk
 */
export interface Chunk {
     ...
     *
     * @generated from protobuf field: repeated rooms.public.server.v1.Room entities = 4;
     */
    entities: Room[];
}
/**
 ...
 *
 * @generated from protobuf message rooms.public.server.v1.Query
 */
export interface Query {
    /**
     * Represents the order in which results should be retrieved.
     *
     * @generated from protobuf field: rooms.public.server.v1.Order order = 1;
     */
    order: Order;
    /**
     ...
     *
     * @generated from protobuf field: rooms.public.server.v1.Condition condition = 4;
     */
    condition?: Condition;
}
/**
 ...
 *
 * @generated from protobuf message rooms.public.server.v1.Context
 */
export interface Context {
     ...
     *
     * @generated from protobuf field: rooms.public.server.v1.Timeframe room_timeframe = 2;
     */
     ...
     *
     * @generated from protobuf field: rooms.public.server.v1.Timeframe member_timeframe = 4;
     */
    memberTimeframe?: Timeframe;
    /**
     * todo;
     *
     * @generated from protobuf field: repeated members.public.server.v1.Member members = 5;
     */
    members: Member[];
    /**
     ...
     *
     * @generated from protobuf field: rooms.public.server.v1.Timeframe members_timeframe = 6;
     */
 ...
 *
 * @generated from protobuf message rooms.public.server.v1.Condition
 */
 ...
 *
 * @generated from protobuf message rooms.public.server.v1.Timeframe
 */
...
class Room$Type extends MessageType<Room> {
    constructor() {
        super("rooms.public.server.v1.Room", [
    ...
    create(value?: PartialMessage<Room>): Room {
        const message = { id: "", chatId: "", metadata: {}, createTime: 0n, updateTime: 0n };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field rooms.public.server.v1.Room.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message rooms.public.server.v1.Room
 */
export const Room = new Room$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("rooms.public.server.v1.Chunk", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total */ 3:
                    ...
                    break;
                case /* repeated rooms.public.server.v1.Room entities */ 4:
    ...
    internalBinaryWrite(message: Chunk, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated rooms.public.server.v1.Room entities = 4; */
...
/**
 * @generated MessageType for protobuf message rooms.public.server.v1.Chunk
 */
export const Chunk = new Chunk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Query$Type extends MessageType<Query> {
    constructor() {
        super("rooms.public.server.v1.Query", [
            { no: 1, name: "order", kind: "enum", T: () => ["rooms.public.server.v1.Order", Order] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Query): Query {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* rooms.public.server.v1.Order order */ 1:
                ...
                case /* int64 offset */ 3:
                    ...
                    break;
                case /* rooms.public.server.v1.Condition condition */ 4:
    ...
    internalBinaryWrite(message: Query, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* rooms.public.server.v1.Order order = 1; */
        if (message.order !== 0)
        ...
        /* rooms.public.server.v1.Condition condition = 4; */
...
/**
 * @generated MessageType for protobuf message rooms.public.server.v1.Query
 */
export const Query = new Query$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Context$Type extends MessageType<Context> {
    constructor() {
        super("rooms.public.server.v1.Context", [
            ...
            { no: 5, name: "members", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Member },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* rooms.public.server.v1.Room room */ 1:
                    ...
                    break;
                case /* rooms.public.server.v1.Timeframe room_timeframe */ 2:
    ...
    internalBinaryWrite(message: Context, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* rooms.public.server.v1.Timeframe room_timeframe = 2; */
        ...
        /* rooms.public.server.v1.Timeframe member_timeframe = 4; */
        ...
        /* repeated members.public.server.v1.Member members = 5; */
        for (let i = 0; i < message.members.length; i++)
            Member.internalBinaryWrite(message.members[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* rooms.public.server.v1.Timeframe members_timeframe = 6; */
...
/**
 * @generated MessageType for protobuf message rooms.public.server.v1.Context
 */
export const Context = new Context$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Condition$Type extends MessageType<Condition> {
    constructor() {
        super("rooms.public.server.v1.Condition", [
...
/**
 * @generated MessageType for protobuf message rooms.public.server.v1.Condition
 */
export const Condition = new Condition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Timeframe$Type extends MessageType<Timeframe> {
    constructor() {
        super("rooms.public.server.v1.Timeframe", [
...
/**
 * @generated MessageType for protobuf message rooms.public.server.v1.Timeframe
 */
