...
// @generated from protobuf file "room/rooms/public/server/v1/services.proto" (package "rooms.public.server.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf service rooms.public.server.v1.Service
 */
export interface IServiceClient {
    /**
     * Count represents a procedure that retrieves the total number of rooms based on a specific query.
     *
     * @generated from protobuf rpc: Count(rooms.public.server.v1.CountRequest) returns (rooms.public.server.v1.CountResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Range(rooms.public.server.v1.RangeRequest) returns (rooms.public.server.v1.RangeResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Select(rooms.public.server.v1.SelectRequest) returns (rooms.public.server.v1.SelectResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Context(rooms.public.server.v1.ContextRequest) returns (rooms.public.server.v1.ContextResponse);
     */
