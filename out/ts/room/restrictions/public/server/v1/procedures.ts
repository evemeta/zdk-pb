...
// @generated from protobuf file "room/restrictions/public/server/v1/procedures.proto" (package "room.restrictions.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message room.restrictions.public.server.v1.CountRequest
 */
export interface CountRequest {
    /**
     * Represents the specifications and conditions under which restrictions should be counted.
     *
     * @generated from protobuf field: room.restrictions.public.server.v1.Query query = 1;
     */
    query?: Query;
}
/**
 ...
 *
 * @generated from protobuf message room.restrictions.public.server.v1.CountResponse
 */
 ...
 *
 * @generated from protobuf message room.restrictions.public.server.v1.SelectRequest
 */
 ...
 *
 * @generated from protobuf message room.restrictions.public.server.v1.SelectResponse
 */
export interface SelectResponse {
    /**
     * Represents a list of restrictions that match the criteria of the given query.
     *
     * @generated from protobuf field: repeated room.restrictions.public.server.v1.Restriction restrictions = 1;
     */
 ...
 *
 * @generated from protobuf message room.restrictions.public.server.v1.RangeRequest
 */
 ...
 *
 * @generated from protobuf message room.restrictions.public.server.v1.RangeResponse
 */
...
class CountRequest$Type extends MessageType<CountRequest> {
    constructor() {
        super("room.restrictions.public.server.v1.CountRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CountRequest): CountRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* room.restrictions.public.server.v1.Query query */ 1:
...
/**
 * @generated MessageType for protobuf message room.restrictions.public.server.v1.CountRequest
 */
export const CountRequest = new CountRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CountResponse$Type extends MessageType<CountResponse> {
    constructor() {
        super("room.restrictions.public.server.v1.CountResponse", [
...
/**
 * @generated MessageType for protobuf message room.restrictions.public.server.v1.CountResponse
 */
export const CountResponse = new CountResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SelectRequest$Type extends MessageType<SelectRequest> {
    constructor() {
        super("room.restrictions.public.server.v1.SelectRequest", [
            { no: 1, name: "query", kind: "message", T: () => Query }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message room.restrictions.public.server.v1.SelectRequest
 */
export const SelectRequest = new SelectRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SelectResponse$Type extends MessageType<SelectResponse> {
    constructor() {
        super("room.restrictions.public.server.v1.SelectResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SelectResponse): SelectResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated room.restrictions.public.server.v1.Restriction restrictions */ 1:
...
/**
 * @generated MessageType for protobuf message room.restrictions.public.server.v1.SelectResponse
 */
export const SelectResponse = new SelectResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeRequest$Type extends MessageType<RangeRequest> {
    constructor() {
        super("room.restrictions.public.server.v1.RangeRequest", [
            { no: 1, name: "query", kind: "message", T: () => Query }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message room.restrictions.public.server.v1.RangeRequest
 */
export const RangeRequest = new RangeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeResponse$Type extends MessageType<RangeResponse> {
    constructor() {
        super("room.restrictions.public.server.v1.RangeResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RangeResponse): RangeResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* room.restrictions.public.server.v1.Chunk chunk */ 1:
