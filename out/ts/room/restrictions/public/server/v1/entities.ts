...
export namespace room.restrictions.public.server.v1 {
    export class Chunk extends pb_1.Message {
        ...
        get entities() {
            return pb_1.Message.getRepeatedWrapperField(this, Restriction, 4) as Restriction[];
        }
        set entities(value: Restriction[]) {
        ...
        static fromObject(data: {
            ...
            index?: number;
            total?: number;
            entities?: ReturnType<typeof Restriction.prototype.toObject>[];
        }): Chunk {
            ...
            if (data.entities != null) {
                message.entities = data.entities.map(item => Restriction.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.entities != null) {
                data.entities = this.entities.map((item: Restriction) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.entities.length)
                writer.writeRepeatedMessage(4, this.entities, (item: Restriction) => item.serialize(writer));
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.entities, () => pb_1.Message.addToRepeatedWrapperField(message, 4, Restriction.deserialize(reader), Restriction));
                        break;
    ...
    export class Query extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            order?: dependency_1.room.restrictions.public.server.v1.Order;
            limit?: number;
            offset?: number;
            condition?: Condition;
        }) {
        ...
        get order() {
            return pb_1.Message.getFieldWithDefault(this, 1, dependency_1.room.restrictions.public.server.v1.Order.Unknown) as dependency_1.room.restrictions.public.server.v1.Order;
        }
        set order(value: dependency_1.room.restrictions.public.server.v1.Order) {
            pb_1.Message.setField(this, 1, value);
        }
        get limit() {
            return pb_1.Message.getFieldWithDefault(this, 2, 0) as number;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.order != dependency_1.room.restrictions.public.server.v1.Order.Unknown)
    ...
    export class Restriction extends pb_1.Message {
        ...
        get kind() {
            return pb_1.Message.getFieldWithDefault(this, 4, dependency_1.room.restrictions.public.server.v1.Kind.Unknown) as dependency_1.room.restrictions.public.server.v1.Kind;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.expire_time != 0)
                writer.writeInt64(7, this.expire_time);
            if (!w)
                return writer.getResultBuffer();
        }
