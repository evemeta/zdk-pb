...
// @generated from protobuf file "chat/messages/public/server/v1/entities.proto" (package "chat.messages.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message chat.messages.public.server.v1.Chunk
 */
export interface Chunk {
     ...
     *
     * @generated from protobuf field: repeated chat.messages.public.server.v1.Message entities = 4;
     */
    entities: Message[];
}
/**
 ...
 *
 * @generated from protobuf message chat.messages.public.server.v1.Query
 */
export interface Query {
    /**
     * Represents the order in which results should be retrieved.
     *
     * @generated from protobuf field: chat.messages.public.server.v1.Order order = 1;
     */
    order: Order;
    /**
     ...
     *
     * @generated from protobuf field: chat.messages.public.server.v1.Condition condition = 4;
     */
    condition?: Condition;
}
/**
 ...
 *
 * @generated from protobuf message chat.messages.public.server.v1.Message
 */
 ...
 *
 * @generated from protobuf message chat.messages.public.server.v1.Condition
 */
 ...
 *
 * @generated from protobuf message chat.messages.public.server.v1.Timeframe
 */
...
class Chunk$Type extends MessageType<Chunk> {
    constructor() {
        super("chat.messages.public.server.v1.Chunk", [
            ...
            { no: 4, name: "entities", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Message }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 total */ 3:
                    ...
                    break;
                case /* repeated chat.messages.public.server.v1.Message entities */ 4:
...
/**
 * @generated MessageType for protobuf message chat.messages.public.server.v1.Chunk
 */
export const Chunk = new Chunk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Query$Type extends MessageType<Query> {
    constructor() {
        super("chat.messages.public.server.v1.Query", [
            { no: 1, name: "order", kind: "enum", T: () => ["chat.messages.public.server.v1.Order", Order] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Query): Query {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* chat.messages.public.server.v1.Order order */ 1:
                ...
                case /* int64 offset */ 3:
                    ...
                    break;
                case /* chat.messages.public.server.v1.Condition condition */ 4:
    ...
    internalBinaryWrite(message: Query, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* chat.messages.public.server.v1.Order order = 1; */
        if (message.order !== 0)
        ...
        /* chat.messages.public.server.v1.Condition condition = 4; */
...
/**
 * @generated MessageType for protobuf message chat.messages.public.server.v1.Query
 */
export const Query = new Query$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Message$Type extends MessageType<Message> {
    constructor() {
        super("chat.messages.public.server.v1.Message", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field chat.messages.public.server.v1.Message.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message chat.messages.public.server.v1.Message
 */
export const Message = new Message$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Condition$Type extends MessageType<Condition> {
    constructor() {
        super("chat.messages.public.server.v1.Condition", [
...
/**
 * @generated MessageType for protobuf message chat.messages.public.server.v1.Condition
 */
export const Condition = new Condition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Timeframe$Type extends MessageType<Timeframe> {
    constructor() {
        super("chat.messages.public.server.v1.Timeframe", [
...
/**
 * @generated MessageType for protobuf message chat.messages.public.server.v1.Timeframe
 */
