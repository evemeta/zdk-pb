...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.RangeRequest
 */
export const RangeRequest = new RangeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeResponse$Type extends MessageType<RangeResponse> {
    constructor() {
        super("messages.public.server.v1.RangeResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RangeResponse): RangeResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* messages.public.server.v1.Chunk chunk */ 1:
    ...
    internalBinaryWrite(message: RangeResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* messages.public.server.v1.Chunk chunk = 1; */
        if (message.chunk)
...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.RangeResponse
 */
export const RangeResponse = new RangeResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateRequest$Type extends MessageType<CreateRequest> {
    constructor() {
        super("messages.public.server.v1.CreateRequest", [
...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.CreateRequest
 */
export const CreateRequest = new CreateRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateResponse$Type extends MessageType<CreateResponse> {
    constructor() {
        super("messages.public.server.v1.CreateResponse", [
...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.CreateResponse
 */
...
class UpdateResponse$Type extends MessageType<UpdateResponse> {
    constructor() {
        super("messages.public.server.v1.UpdateResponse", [
            { no: 1, name: "message", kind: "message", T: () => Message }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.UpdateResponse
 */
export const UpdateResponse = new UpdateResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteRequest$Type extends MessageType<DeleteRequest> {
    constructor() {
        super("messages.public.server.v1.DeleteRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.DeleteRequest
 */
export const DeleteRequest = new DeleteRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteResponse$Type extends MessageType<DeleteResponse> {
    constructor() {
        super("messages.public.server.v1.DeleteResponse", [
            { no: 1, name: "message", kind: "message", T: () => Message }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message messages.public.server.v1.DeleteResponse
 */
