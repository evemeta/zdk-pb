...
// @generated from protobuf file "chat/chats/public/server/v1/procedures.proto" (package "chat.chats.public.server.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.CountRequest
 */
export interface CountRequest {
    /**
     * Represents the specifications and conditions under which chats should be counted.
     *
     * @generated from protobuf field: chat.chats.public.server.v1.Query query = 1;
     */
    query?: Query;
}
/**
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.CountResponse
 */
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.SelectRequest
 */
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.SelectResponse
 */
export interface SelectResponse {
    /**
     * Represents a list of chats that match the criteria of the given query.
     *
     * @generated from protobuf field: repeated chat.chats.public.server.v1.Chat chats = 1;
     */
    chats: Chat[];
}
/**
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.RangeRequest
 */
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.RangeResponse
 */
export interface RangeResponse {
    /**
     * Represents a chunk of chats that match the criteria of the given query.
     *
     * @generated from protobuf field: chat.chats.public.server.v1.Chunk chunk = 1;
     */
    chunk?: Chunk;
}
/**
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.ContextRequest
 */
 ...
 *
 * @generated from protobuf message chat.chats.public.server.v1.ContextResponse
 */
export interface ContextResponse {
     ...
     *
     * @generated from protobuf field: chat.chats.public.server.v1.Context context = 1;
     */
    context?: Context;
}
...
class CountRequest$Type extends MessageType<CountRequest> {
    constructor() {
        super("chat.chats.public.server.v1.CountRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CountRequest): CountRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* chat.chats.public.server.v1.Query query */ 1:
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.CountRequest
 */
export const CountRequest = new CountRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CountResponse$Type extends MessageType<CountResponse> {
    constructor() {
        super("chat.chats.public.server.v1.CountResponse", [
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.CountResponse
 */
export const CountResponse = new CountResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SelectRequest$Type extends MessageType<SelectRequest> {
    constructor() {
        super("chat.chats.public.server.v1.SelectRequest", [
            { no: 1, name: "query", kind: "message", T: () => Query }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.SelectRequest
 */
...
class SelectResponse$Type extends MessageType<SelectResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SelectResponse): SelectResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated chat.chats.public.server.v1.Chat chats */ 1:
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.SelectResponse
 */
export const SelectResponse = new SelectResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeRequest$Type extends MessageType<RangeRequest> {
    constructor() {
        super("chat.chats.public.server.v1.RangeRequest", [
            { no: 1, name: "query", kind: "message", T: () => Query }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.RangeRequest
 */
export const RangeRequest = new RangeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RangeResponse$Type extends MessageType<RangeResponse> {
    constructor() {
        super("chat.chats.public.server.v1.RangeResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RangeResponse): RangeResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* chat.chats.public.server.v1.Chunk chunk */ 1:
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.RangeResponse
 */
export const RangeResponse = new RangeResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ContextRequest$Type extends MessageType<ContextRequest> {
    constructor() {
        super("chat.chats.public.server.v1.ContextRequest", [
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.ContextRequest
 */
export const ContextRequest = new ContextRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ContextResponse$Type extends MessageType<ContextResponse> {
    constructor() {
        super("chat.chats.public.server.v1.ContextResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ContextResponse): ContextResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* chat.chats.public.server.v1.Context context */ 1:
...
/**
 * @generated MessageType for protobuf message chat.chats.public.server.v1.ContextResponse
 */
