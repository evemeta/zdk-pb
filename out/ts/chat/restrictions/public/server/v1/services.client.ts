...
// @generated from protobuf file "chat/restrictions/public/server/v1/services.proto" (package "chat.restrictions.public.server.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf service chat.restrictions.public.server.v1.Service
 */
export interface IServiceClient {
    /**
     * Count represents a procedure that retrieves the total number of restrictions based on a specific query.
     *
     * @generated from protobuf rpc: Count(chat.restrictions.public.server.v1.CountRequest) returns (chat.restrictions.public.server.v1.CountResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Range(chat.restrictions.public.server.v1.RangeRequest) returns (chat.restrictions.public.server.v1.RangeResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Select(chat.restrictions.public.server.v1.SelectRequest) returns (chat.restrictions.public.server.v1.SelectResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Create(chat.restrictions.public.server.v1.CreateRequest) returns (chat.restrictions.public.server.v1.CreateResponse);
     */
     ...
     *
     * @generated from protobuf rpc: Delete(chat.restrictions.public.server.v1.DeleteRequest) returns (chat.restrictions.public.server.v1.DeleteResponse);
     */
