...
// @generated from protobuf file "user/users/public/v1/messages.proto" (package "users.public.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message users.public.v1.User
 */
export interface User {
    ...
    nickname: string;
    /**
     * @generated from protobuf field: repeated users.public.v1.Permission permissions = 5;
     */
...
class User$Type extends MessageType<User> {
    constructor() {
        super("users.public.v1.User", [
            ...
            { no: 5, name: "permissions", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["users.public.v1.Permission", Permission] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string nickname */ 4:
                    ...
                    break;
                case /* repeated users.public.v1.Permission permissions */ 5:
    ...
    internalBinaryWrite(message: User, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated users.public.v1.Permission permissions = 5; */
...
/**
 * @generated MessageType for protobuf message users.public.v1.User
 */
