...
public struct Room_Members_Public_Server_V1_Chunk {
  ...
  public var entities: [Room_Members_Public_Server_V1_Member] = []
...
public struct Room_Members_Public_Server_V1_Query {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Represents the order in which results should be retrieved.
  public var order: Room_Members_Public_Server_V1_Order = .unknown
  ...
  public var condition: Room_Members_Public_Server_V1_Condition {
    get {return _condition ?? Room_Members_Public_Server_V1_Condition()}
  ...
  fileprivate var _condition: Room_Members_Public_Server_V1_Condition? = nil
}
...
public struct Room_Members_Public_Server_V1_Member {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Room_Members_Public_Server_V1_Condition {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// todo;
  public var statuses: [Room_Members_Public_Server_V1_Status] = []
...
public struct Room_Members_Public_Server_V1_Timeframe {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Room_Members_Public_Server_V1_Chunk: @unchecked Sendable {}
extension Room_Members_Public_Server_V1_Query: @unchecked Sendable {}
extension Room_Members_Public_Server_V1_Member: @unchecked Sendable {}
extension Room_Members_Public_Server_V1_Condition: @unchecked Sendable {}
extension Room_Members_Public_Server_V1_Timeframe: @unchecked Sendable {}
...
extension Room_Members_Public_Server_V1_Chunk: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Room_Members_Public_Server_V1_Chunk, rhs: Room_Members_Public_Server_V1_Chunk) -> Bool {
...
extension Room_Members_Public_Server_V1_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Room_Members_Public_Server_V1_Query, rhs: Room_Members_Public_Server_V1_Query) -> Bool {
...
extension Room_Members_Public_Server_V1_Member: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Room_Members_Public_Server_V1_Member, rhs: Room_Members_Public_Server_V1_Member) -> Bool {
...
extension Room_Members_Public_Server_V1_Condition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.roomIds) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.roomIds.isEmpty {
      try visitor.visitRepeatedStringField(value: self.roomIds, fieldNumber: 2)
    }
  ...
  public static func ==(lhs: Room_Members_Public_Server_V1_Condition, rhs: Room_Members_Public_Server_V1_Condition) -> Bool {
...
extension Room_Members_Public_Server_V1_Timeframe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Room_Members_Public_Server_V1_Timeframe, rhs: Room_Members_Public_Server_V1_Timeframe) -> Bool {
