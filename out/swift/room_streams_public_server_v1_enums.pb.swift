...
public enum Room_Streams_Public_Server_V1_Order: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
  case ascending // = 1
  case descending // = 2
...
public enum Room_Streams_Public_Server_V1_Status: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
  case enabled // = 1
  case disabled // = 2
