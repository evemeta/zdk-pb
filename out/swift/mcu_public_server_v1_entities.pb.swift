...
public struct Mcu_Public_Server_V1_Empty {
...
public struct Mcu_Public_Server_V1_Resolution {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Mcu_Public_Server_V1_LayoutCell {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Mcu_Public_Server_V1_CellConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Mcu_Public_Server_V1_Layout {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Mcu_Public_Server_V1_Room {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Mcu_Public_Server_V1_Empty: @unchecked Sendable {}
extension Mcu_Public_Server_V1_Resolution: @unchecked Sendable {}
extension Mcu_Public_Server_V1_LayoutCell: @unchecked Sendable {}
extension Mcu_Public_Server_V1_CellConfig: @unchecked Sendable {}
extension Mcu_Public_Server_V1_Layout: @unchecked Sendable {}
extension Mcu_Public_Server_V1_Room: @unchecked Sendable {}
