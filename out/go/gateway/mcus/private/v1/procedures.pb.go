...
func (x *CreateArgument) GetNode() string {
	if x != nil {
		return x.Node
	}
	return ""
...
type UpdateArgument struct {
	...
	Node          *OptionalString        `protobuf:"bytes,2,opt,name=node,proto3,oneof" json:"node,omitempty"`
...
func (x *UpdateArgument) GetNode() *OptionalString {
	if x != nil {
		return x.Node
	}
	return nil
...
const file_gateway_mcus_private_v1_procedures_proto_rawDesc = "" +
	...
	"\x04mcus\x18\x01 \x03(\v2\x1c.gateway.mcus.private.v1.McuR\x04mcus\"\xb7\x01\n" +
	"\x0eCreateArgument\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x15\n" +
	"\x06job_id\x18\x02 \x01(\tR\x05jobId\x12\x17\n" +
	"\aroom_id\x18\x03 \x01(\tR\x06roomId\x12\x12\n" +
	"\x04node\x18\x04 \x01(\tR\x04node\x127\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1f.gateway.mcus.private.v1.StatusR\x06status\x12\x18\n" +
	"\aaddress\x18\x06 \x01(\tR\aaddress\"V\n" +
	"\rCreateRequest\x12E\n" +
	...
	"\tmutations\x18\x01 \x03(\v2'.gateway.mcus.private.v1.CreateMutationR\tmutations\"\xb6\x02\n" +
	"\x0eUpdateArgument\x124\n" +
	"\x05query\x18\x01 \x01(\v2\x1e.gateway.mcus.private.v1.QueryR\x05query\x12@\n" +
	"\x04node\x18\x02 \x01(\v2'.gateway.mcus.private.v1.OptionalStringH\x00R\x04node\x88\x01\x01\x12D\n" +
	...
	"\x16StartBroadcastResponse\"\xa9\x02\n" +
	"\x16StartBroadcastMutation\x12O\n" +
	"\n" +
	"foundation\x18\x01 \x01(\v2/.gateway.mcus.private.v1.StartBroadcastArgumentR\n" +
	"foundation\x12N\n" +
	"\tcondition\x18\x02 \x01(\v20.gateway.mcus.private.v1.StartBroadcastConditionR\tcondition\x12\x1c\n" +
	"\ttransient\x18\x03 \x01(\bR\ttransient\x12'\n" +
	...
	"\x15StopBroadcastResponse\"\xa6\x02\n" +
	"\x15StopBroadcastMutation\x12N\n" +
	"\n" +
	"foundation\x18\x01 \x01(\v2..gateway.mcus.private.v1.StopBroadcastArgumentR\n" +
	"foundation\x12M\n" +
	"\tcondition\x18\x02 \x01(\v2/.gateway.mcus.private.v1.StopBroadcastConditionR\tcondition\x12\x1c\n" +
	"\ttransient\x18\x03 \x01(\bR\ttransient\x12'\n" +
	"\x0fbegin_timestamp\x18\x04 \x01(\x03R\x0ebeginTimestamp\x12'\n" +
	...
	"\tmutations\x18\x01 \x03(\v2..gateway.mcus.private.v1.StopBroadcastMutationR\tmutationsBAZ?github.com/evemeta/zdk-pb/out/go/gateway/mcus/private/v1;mcuspbb\x06proto3"
...
var file_gateway_mcus_private_v1_procedures_proto_goTypes = []any{
	...
	(Status)(0),                       // 39: gateway.mcus.private.v1.Status
	(*Transient)(nil),                 // 40: gateway.mcus.private.v1.Transient
	(*OptionalString)(nil),            // 41: gateway.mcus.private.v1.OptionalString
	(*OptionalStatus)(nil),            // 42: gateway.mcus.private.v1.OptionalStatus
}
var file_gateway_mcus_private_v1_procedures_proto_depIdxs = []int32{
	...
	39, // 8: gateway.mcus.private.v1.CreateArgument.status:type_name -> gateway.mcus.private.v1.Status
	9,  // 9: gateway.mcus.private.v1.CreateRequest.arguments:type_name -> gateway.mcus.private.v1.CreateArgument
	38, // 10: gateway.mcus.private.v1.CreateResponse.mcus:type_name -> gateway.mcus.private.v1.Mcu
	9,  // 11: gateway.mcus.private.v1.CreateMutation.foundation:type_name -> gateway.mcus.private.v1.CreateArgument
	40, // 12: gateway.mcus.private.v1.CreateMutation.transient:type_name -> gateway.mcus.private.v1.Transient
	12, // 13: gateway.mcus.private.v1.CreateTransaction.mutations:type_name -> gateway.mcus.private.v1.CreateMutation
	36, // 14: gateway.mcus.private.v1.UpdateArgument.query:type_name -> gateway.mcus.private.v1.Query
	41, // 15: gateway.mcus.private.v1.UpdateArgument.node:type_name -> gateway.mcus.private.v1.OptionalString
	42, // 16: gateway.mcus.private.v1.UpdateArgument.status:type_name -> gateway.mcus.private.v1.OptionalStatus
	41, // 17: gateway.mcus.private.v1.UpdateArgument.address:type_name -> gateway.mcus.private.v1.OptionalString
	14, // 18: gateway.mcus.private.v1.UpdateRequest.arguments:type_name -> gateway.mcus.private.v1.UpdateArgument
	38, // 19: gateway.mcus.private.v1.UpdateResponse.mcus:type_name -> gateway.mcus.private.v1.Mcu
	14, // 20: gateway.mcus.private.v1.UpdateMutation.foundation:type_name -> gateway.mcus.private.v1.UpdateArgument
	40, // 21: gateway.mcus.private.v1.UpdateMutation.transient:type_name -> gateway.mcus.private.v1.Transient
	17, // 22: gateway.mcus.private.v1.UpdateTransaction.mutations:type_name -> gateway.mcus.private.v1.UpdateMutation
	36, // 23: gateway.mcus.private.v1.DeleteArgument.query:type_name -> gateway.mcus.private.v1.Query
	19, // 24: gateway.mcus.private.v1.DeleteRequest.arguments:type_name -> gateway.mcus.private.v1.DeleteArgument
	38, // 25: gateway.mcus.private.v1.DeleteResponse.mcus:type_name -> gateway.mcus.private.v1.Mcu
	19, // 26: gateway.mcus.private.v1.DeleteMutation.foundation:type_name -> gateway.mcus.private.v1.DeleteArgument
	40, // 27: gateway.mcus.private.v1.DeleteMutation.transient:type_name -> gateway.mcus.private.v1.Transient
	22, // 28: gateway.mcus.private.v1.DeleteTransaction.mutations:type_name -> gateway.mcus.private.v1.DeleteMutation
	24, // 29: gateway.mcus.private.v1.StartBroadcastRequest.arguments:type_name -> gateway.mcus.private.v1.StartBroadcastArgument
	24, // 30: gateway.mcus.private.v1.StartBroadcastMutation.foundation:type_name -> gateway.mcus.private.v1.StartBroadcastArgument
	28, // 31: gateway.mcus.private.v1.StartBroadcastMutation.condition:type_name -> gateway.mcus.private.v1.StartBroadcastCondition
	38, // 32: gateway.mcus.private.v1.StartBroadcastCondition.mcus:type_name -> gateway.mcus.private.v1.Mcu
	27, // 33: gateway.mcus.private.v1.StartBroadcastTransaction.mutations:type_name -> gateway.mcus.private.v1.StartBroadcastMutation
	30, // 34: gateway.mcus.private.v1.StopBroadcastRequest.arguments:type_name -> gateway.mcus.private.v1.StopBroadcastArgument
	30, // 35: gateway.mcus.private.v1.StopBroadcastMutation.foundation:type_name -> gateway.mcus.private.v1.StopBroadcastArgument
	34, // 36: gateway.mcus.private.v1.StopBroadcastMutation.condition:type_name -> gateway.mcus.private.v1.StopBroadcastCondition
	38, // 37: gateway.mcus.private.v1.StopBroadcastCondition.mcus:type_name -> gateway.mcus.private.v1.Mcu
	33, // 38: gateway.mcus.private.v1.StopBroadcastTransaction.mutations:type_name -> gateway.mcus.private.v1.StopBroadcastMutation
