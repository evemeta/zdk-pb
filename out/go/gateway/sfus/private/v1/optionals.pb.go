...
const file_gateway_sfus_private_v1_optionals_proto_rawDesc = "" +
	"\n" +
	"'gateway/sfus/private/v1/optionals.proto\x12\x17gateway.sfus.private.v1\x1a#gateway/sfus/private/v1/enums.proto\"C\n" +
	"\fOptionalZone\x123\n" +
	"\x05value\x18\x01 \x01(\x0e2\x1d.gateway.sfus.private.v1.ZoneR\x05value\"G\n" +
	"\x0eOptionalStatus\x125\n" +
	"\x05value\x18\x01 \x01(\x0e2\x1f.gateway.sfus.private.v1.StatusR\x05value\"&\n" +
	"\x0eOptionalString\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05valueBAZ?gitlab.com/evemeta/zdk/pb/out/go/gateway/sfus/private/v1;sfuspbb\x06proto3"

var (
	file_gateway_sfus_private_v1_optionals_proto_rawDescOnce sync.Once
	file_gateway_sfus_private_v1_optionals_proto_rawDescData []byte
)
...
func file_gateway_sfus_private_v1_optionals_proto_rawDescGZIP() []byte {
	file_gateway_sfus_private_v1_optionals_proto_rawDescOnce.Do(func() {
		file_gateway_sfus_private_v1_optionals_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gateway_sfus_private_v1_optionals_proto_rawDesc), len(file_gateway_sfus_private_v1_optionals_proto_rawDesc)))
	})
...
func file_gateway_sfus_private_v1_optionals_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gateway_sfus_private_v1_optionals_proto_rawDesc), len(file_gateway_sfus_private_v1_optionals_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
