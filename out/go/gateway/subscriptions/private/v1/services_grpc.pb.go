...
const (
	Service_Select_FullMethodName = "/gateway.subscriptions.private.v1.Service/Select"
	Service_Ensure_FullMethodName = "/gateway.subscriptions.private.v1.Service/Ensure"
)
...
func (c *serviceClient) Ensure(ctx context.Context, in *EnsureRequest, opts ...grpc.CallOption) (*EnsureResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EnsureResponse)
	err := c.cc.Invoke(ctx, Service_Ensure_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) Ensure(context.Context, *EnsureRequest) (*EnsureResponse, error) {
...
func _Service_Ensure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnsureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).Ensure(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_Ensure_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).Ensure(ctx, req.(*EnsureRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gateway.subscriptions.private.v1.Service",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Ensure",
			Handler:    _Service_Ensure_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "gateway/subscriptions/private/v1/services.proto",
}
