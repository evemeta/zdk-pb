...
func (c *serviceClient) Select(ctx context.Context, in *SelectRequest, opts ...grpc.CallOption) (*SelectResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.subscriptions.private.v1.Service/Select", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) Ensure(ctx context.Context, in *EnsureRequest, opts ...grpc.CallOption) (*EnsureResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.subscriptions.private.v1.Service/Ensure", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Select_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.subscriptions.private.v1.Service/Select",
	}
...
func _Service_Ensure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.subscriptions.private.v1.Service/Ensure",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
