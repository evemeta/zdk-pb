...
const file_gateway_streamers_private_v1_enums_proto_rawDesc = "" +
	"\n" +
	"(gateway/streamers/private/v1/enums.proto\x12\x1cgateway.streamers.private.v1*\x82\x01\n" +
	"\x04Zone\x12\x0f\n" +
	...
	"\x11StatusTerminating\x10\x04BKZIgithub.com/evemeta/zdk-pb/out/go/gateway/streamers/private/v1;streamerspbb\x06proto3"

var (
	file_gateway_streamers_private_v1_enums_proto_rawDescOnce sync.Once
	file_gateway_streamers_private_v1_enums_proto_rawDescData []byte
)
...
func file_gateway_streamers_private_v1_enums_proto_rawDescGZIP() []byte {
	file_gateway_streamers_private_v1_enums_proto_rawDescOnce.Do(func() {
		file_gateway_streamers_private_v1_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gateway_streamers_private_v1_enums_proto_rawDesc), len(file_gateway_streamers_private_v1_enums_proto_rawDesc)))
	})
...
func file_gateway_streamers_private_v1_enums_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gateway_streamers_private_v1_enums_proto_rawDesc), len(file_gateway_streamers_private_v1_enums_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
