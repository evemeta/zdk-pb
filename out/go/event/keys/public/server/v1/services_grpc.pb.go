...
const (
	Service_Count_FullMethodName  = "/event.keys.public.server.v1.Service/Count"
	Service_Range_FullMethodName  = "/event.keys.public.server.v1.Service/Range"
	Service_Select_FullMethodName = "/event.keys.public.server.v1.Service/Select"
)
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "event.keys.public.server.v1.Service",
	...
	Metadata: "event/keys/public/server/v1/services.proto",
}
