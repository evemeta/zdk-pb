...
const (
	Service_Count_FullMethodName  = "/event.restrictions.public.server.v1.Service/Count"
	Service_Range_FullMethodName  = "/event.restrictions.public.server.v1.Service/Range"
	Service_Select_FullMethodName = "/event.restrictions.public.server.v1.Service/Select"
	Service_Create_FullMethodName = "/event.restrictions.public.server.v1.Service/Create"
	Service_Delete_FullMethodName = "/event.restrictions.public.server.v1.Service/Delete"
)
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "event.restrictions.public.server.v1.Service",
	...
	Metadata: "event/restrictions/public/server/v1/services.proto",
}
