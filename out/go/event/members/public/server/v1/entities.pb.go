...
const file_event_members_public_server_v1_entities_proto_rawDesc = "" +
	"\n" +
	"-event/members/public/server/v1/entities.proto\x12\x1eevent.members.public.server.v1\x1a*event/members/public/server/v1/enums.proto\"\x8b\x01\n" +
	"\x05Chunk\x12\x12\n" +
	...
	"\bentities\x18\x04 \x03(\v2&.event.members.public.server.v1.MemberR\bentities\"\xbb\x01\n" +
	"\x05Query\x12;\n" +
	...
	"\tevent_ids\x18\x02 \x03(\tR\beventIds\x12B\n" +
	"\bstatuses\x18\x03 \x03(\x0e2&.event.members.public.server.v1.StatusR\bstatuses\"C\n" +
	"\tTimeframe\x12\x1a\n" +
	"\bcommence\x18\x01 \x01(\x03R\bcommence\x12\x1a\n" +
	"\bcomplete\x18\x02 \x01(\x03R\bcompleteBv\n" +
...
var (
	...
	file_event_members_public_server_v1_entities_proto_rawDescData []byte
)
...
func file_event_members_public_server_v1_entities_proto_rawDescGZIP() []byte {
	file_event_members_public_server_v1_entities_proto_rawDescOnce.Do(func() {
		file_event_members_public_server_v1_entities_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_event_members_public_server_v1_entities_proto_rawDesc), len(file_event_members_public_server_v1_entities_proto_rawDesc)))
	})
...
func file_event_members_public_server_v1_entities_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_event_members_public_server_v1_entities_proto_rawDesc), len(file_event_members_public_server_v1_entities_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
