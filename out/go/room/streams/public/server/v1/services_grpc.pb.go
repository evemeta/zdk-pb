...
const (
	Service_Count_FullMethodName  = "/room.streams.public.server.v1.Service/Count"
	Service_Range_FullMethodName  = "/room.streams.public.server.v1.Service/Range"
	Service_Select_FullMethodName = "/room.streams.public.server.v1.Service/Select"
	Service_Create_FullMethodName = "/room.streams.public.server.v1.Service/Create"
	Service_Update_FullMethodName = "/room.streams.public.server.v1.Service/Update"
	Service_Delete_FullMethodName = "/room.streams.public.server.v1.Service/Delete"
)
