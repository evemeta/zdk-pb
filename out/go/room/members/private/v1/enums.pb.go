...
const file_room_members_private_v1_enums_proto_rawDesc = "" +
	"\n" +
	"#room/members/private/v1/enums.proto\x12\x17room.members.private.v1*B\n" +
	"\x05Order\x12\x10\n" +
	...
	"\x12PermissionRoomKick\x10\xcb\x01BDZBgithub.com/evemeta/zdk-pb/out/go/room/members/private/v1;memberspbb\x06proto3"

var (
	file_room_members_private_v1_enums_proto_rawDescOnce sync.Once
	file_room_members_private_v1_enums_proto_rawDescData []byte
)
...
func file_room_members_private_v1_enums_proto_rawDescGZIP() []byte {
	file_room_members_private_v1_enums_proto_rawDescOnce.Do(func() {
		file_room_members_private_v1_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_room_members_private_v1_enums_proto_rawDesc), len(file_room_members_private_v1_enums_proto_rawDesc)))
	})
