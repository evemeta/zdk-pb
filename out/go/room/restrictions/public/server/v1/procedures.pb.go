...
const file_room_restrictions_public_server_v1_procedures_proto_rawDesc = "" +
	"\n" +
	"3room/restrictions/public/server/v1/procedures.proto\x12\"room.restrictions.public.server.v1\x1a.room/restrictions/public/server/v1/enums.proto\x1a1room/restrictions/public/server/v1/entities.proto\"O\n" +
	"\fCountRequest\x12?\n" +
	"\x05query\x18\x01 \x01(\v2).room.restrictions.public.server.v1.QueryR\x05query\"%\n" +
	"\rCountResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x03R\x05total\"P\n" +
	"\rSelectRequest\x12?\n" +
	"\x05query\x18\x01 \x01(\v2).room.restrictions.public.server.v1.QueryR\x05query\"e\n" +
	"\x0eSelectResponse\x12S\n" +
	"\frestrictions\x18\x01 \x03(\v2/.room.restrictions.public.server.v1.RestrictionR\frestrictions\"O\n" +
	"\fRangeRequest\x12?\n" +
	"\x05query\x18\x01 \x01(\v2).room.restrictions.public.server.v1.QueryR\x05query\"P\n" +
	"\rRangeResponse\x12?\n" +
	"\x05chunk\x18\x01 \x01(\v2).room.restrictions.public.server.v1.ChunkR\x05chunk\"\xb3\x01\n" +
	"\rCreateRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x17\n" +
	"\aroom_id\x18\x02 \x01(\tR\x06roomId\x12<\n" +
	"\x04kind\x18\x03 \x01(\x0e2(.room.restrictions.public.server.v1.KindR\x04kind\x12\x16\n" +
	"\x06reason\x18\x04 \x01(\tR\x06reason\x12\x1a\n" +
	"\bduration\x18\x05 \x01(\x03R\bduration\"c\n" +
	"\x0eCreateResponse\x12Q\n" +
	"\vrestriction\x18\x01 \x01(\v2/.room.restrictions.public.server.v1.RestrictionR\vrestriction\"\x1f\n" +
	"\rDeleteRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"c\n" +
	"\x0eDeleteResponse\x12Q\n" +
	"\vrestriction\x18\x01 \x01(\v2/.room.restrictions.public.server.v1.RestrictionR\vrestrictionB\x83\x01\n" +
...
var (
	...
	file_room_restrictions_public_server_v1_procedures_proto_rawDescData []byte
)
...
func file_room_restrictions_public_server_v1_procedures_proto_rawDescGZIP() []byte {
	file_room_restrictions_public_server_v1_procedures_proto_rawDescOnce.Do(func() {
		file_room_restrictions_public_server_v1_procedures_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_room_restrictions_public_server_v1_procedures_proto_rawDesc), len(file_room_restrictions_public_server_v1_procedures_proto_rawDesc)))
	})
...
func file_room_restrictions_public_server_v1_procedures_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_room_restrictions_public_server_v1_procedures_proto_rawDesc), len(file_room_restrictions_public_server_v1_procedures_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
