...
const (
	Service_Count_FullMethodName   = "/room.rooms.public.server.v1.Service/Count"
	Service_Range_FullMethodName   = "/room.rooms.public.server.v1.Service/Range"
	Service_Select_FullMethodName  = "/room.rooms.public.server.v1.Service/Select"
	Service_Context_FullMethodName = "/room.rooms.public.server.v1.Service/Context"
)
...
func (c *serviceClient) Context(ctx context.Context, in *ContextRequest, opts ...grpc.CallOption) (*ContextResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_Context_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
