...
const file_mcu_public_server_v1_entities_proto_rawDesc = "" +
	...
	"\n" +
	"resolution\x18\x02 \x01(\v2 .mcu.public.server.v1.ResolutionR\n" +
	"resolution\x128\n" +
	"\x06config\x18\x03 \x03(\v2 .mcu.public.server.v1.LayoutCellR\x06config\x12A\n" +
	"\vcell_config\x18\x04 \x01(\v2 .mcu.public.server.v1.CellConfigR\n" +
	"cellConfig\x12\x18\n" +
	"\aversion\x18\x05 \x01(\x03R\aversion\x12\x12\n" +
	"\x04seed\x18\x06 \x01(\x03R\x04seed\"\x9d\x01\n" +
	"\x04Room\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04seed\x18\x02 \x01(\x03R\x04seed\x12\x19\n" +
	"\buser_ids\x18\x03 \x03(\tR\auserIds\x124\n" +
	"\x06layout\x18\x04 \x01(\v2\x1c.mcu.public.server.v1.LayoutR\x06layout\x12 \n" +
	"\visStreaming\x18\x05 \x01(\bR\visStreamingBb\n" +
...
var (
	...
	file_mcu_public_server_v1_entities_proto_rawDescData []byte
)
...
func file_mcu_public_server_v1_entities_proto_rawDescGZIP() []byte {
	file_mcu_public_server_v1_entities_proto_rawDescOnce.Do(func() {
		file_mcu_public_server_v1_entities_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcu_public_server_v1_entities_proto_rawDesc), len(file_mcu_public_server_v1_entities_proto_rawDesc)))
	})
