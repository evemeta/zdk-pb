...
const file_user_users_public_server_v1_enums_proto_rawDesc = "" +
	"\n" +
	"'user/users/public/server/v1/enums.proto\x12\x1buser.users.public.server.v1*\x89\t\n" +
	"\n" +
	"Permission\x12\x15\n" +
	...
	"\x1fPermissionRoomRestrictionDelete\x10\xa3\x06Bn\n" +
...
var (
	...
	file_user_users_public_server_v1_enums_proto_rawDescData []byte
)
...
func file_user_users_public_server_v1_enums_proto_rawDescGZIP() []byte {
	file_user_users_public_server_v1_enums_proto_rawDescOnce.Do(func() {
		file_user_users_public_server_v1_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_users_public_server_v1_enums_proto_rawDesc), len(file_user_users_public_server_v1_enums_proto_rawDesc)))
	})
...
func file_user_users_public_server_v1_enums_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_user_users_public_server_v1_enums_proto_rawDesc), len(file_user_users_public_server_v1_enums_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
