...
const file_user_users_private_v1_entities_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B@Z>github.com/evemeta/zdk-pb/out/go/user/users/private/v1;userspbb\x06proto3"

var (
	file_user_users_private_v1_entities_proto_rawDescOnce sync.Once
	file_user_users_private_v1_entities_proto_rawDescData []byte
)
...
func file_user_users_private_v1_entities_proto_rawDescGZIP() []byte {
	file_user_users_private_v1_entities_proto_rawDescOnce.Do(func() {
		file_user_users_private_v1_entities_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_users_private_v1_entities_proto_rawDesc), len(file_user_users_private_v1_entities_proto_rawDesc)))
	})
