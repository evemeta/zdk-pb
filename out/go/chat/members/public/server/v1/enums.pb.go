...
const file_chat_members_public_server_v1_enums_proto_rawDesc = "" +
	"\n" +
	")chat/members/public/server/v1/enums.proto\x12\x1dchat.members.public.server.v1*B\n" +
	"\x05Order\x12\x10\n" +
	...
	"\x14RestrictionKindBlock\x10\x02Bt\n" +
...
var (
	...
	file_chat_members_public_server_v1_enums_proto_rawDescData []byte
)
...
func file_chat_members_public_server_v1_enums_proto_rawDescGZIP() []byte {
	file_chat_members_public_server_v1_enums_proto_rawDescOnce.Do(func() {
		file_chat_members_public_server_v1_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chat_members_public_server_v1_enums_proto_rawDesc), len(file_chat_members_public_server_v1_enums_proto_rawDesc)))
	})
