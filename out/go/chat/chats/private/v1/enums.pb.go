...
const file_chat_chats_private_v1_enums_proto_rawDesc = "" +
	"\n" +
	"!chat/chats/private/v1/enums.proto\x12\x15chat.chats.private.v1*?\n" +
	"\x04Kind\x12\x0f\n" +
	...
	"\x16SlowmodeStatusDisabled\x10\x02B@Z>github.com/evemeta/zdk-pb/out/go/chat/chats/private/v1;chatspbb\x06proto3"

var (
	file_chat_chats_private_v1_enums_proto_rawDescOnce sync.Once
	file_chat_chats_private_v1_enums_proto_rawDescData []byte
)

func file_chat_chats_private_v1_enums_proto_rawDescGZIP() []byte {
	file_chat_chats_private_v1_enums_proto_rawDescOnce.Do(func() {
		file_chat_chats_private_v1_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chat_chats_private_v1_enums_proto_rawDesc), len(file_chat_chats_private_v1_enums_proto_rawDesc)))
	})
