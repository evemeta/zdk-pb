...
func (x *Chat) GetRetention() int64 {
	if x != nil {
		return x.Retention
	}
	return 0
...
type Condition struct {
	...
	Members       []*v1.Query            `protobuf:"bytes,3,rep,name=members,proto3" json:"members,omitempty"`
	Messages      []*v11.Query           `protobuf:"bytes,4,rep,name=messages,proto3" json:"messages,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_chat_chats_private_v1_entities_proto_rawDesc = "" +
	"\n" +
	"$chat/chats/private/v1/entities.proto\x12\x15chat.chats.private.v1\x1a!chat/chats/private/v1/enums.proto\x1a&chat/members/private/v1/entities.proto\x1a'chat/messages/private/v1/entities.proto\"\xbe\x03\n" +
	"\x04Chat\x12\x0e\n" +
	...
	"\bmetadata\x18\x05 \x03(\v2).chat.chats.private.v1.Chat.MetadataEntryR\bmetadata\x12;\n" +
	...
	"\buser_ids\x18\x02 \x03(\tR\auserIds\x128\n" +
	"\amembers\x18\x03 \x03(\v2\x1e.chat.members.private.v1.QueryR\amembers\x12;\n" +
	"\bmessages\x18\x04 \x03(\v2\x1f.chat.messages.private.v1.QueryR\bmessages\"\xb0\x01\n" +
	"\tTransient\x123\n" +
	...
	"\bprevious\x18\x03 \x01(\v2\x1b.chat.chats.private.v1.ChatR\bpreviousB@Z>github.com/evemeta/zdk-pb/out/go/chat/chats/private/v1;chatspbb\x06proto3"
